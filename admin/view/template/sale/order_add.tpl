...
<div id="content" data-api-key="<?php echo $api_key; ?>" data-catalog="<?php echo $catalog; ?>" data-token="<?php echo $token; ?>" data-quote-id="<?php echo $quote_id; ?>" data-api-ip="<?php echo $api_id; ?>">
    ...
    <div class="container-fluid">
      <div class="pull-right">
        <div style="float:left">
          <button type="button" data-toggle="tooltip" data-href="<?php echo $process_order_url; ?>" id="button-save" title="Create Order" class="btn btn-primary" disabled="disabled">Create Order</button>
        </div>
        <div style="float:right;margin-left:8px;">
          <a href="<?php echo $cancel; ?>" data-toggle="tooltip" id="button-cancel" title="<?php echo $button_cancel; ?>" class="btn btn-default" style="float:right;"><i class="fa fa-reply"></i></a>
        </div>
      </div>
  ...
  <div class="container-fluid">
    ...
    <div id="tab-customer" style="display:none">
        ...
        <input type="hidden" name="customer_contact_id" value="<?php echo $contact['customer_con_id']; ?>" />
    ...
    <div id="tab-shipping" style="display:none">
        <input type="hidden" name="address_1" value="<?php echo $customer_address['address_1']; ?>" />
        <input type="hidden" name="address_2" value="<?php echo $customer_address['address_2']; ?>" />
        <input type="hidden" name="city" value="<?php echo $customer_address['city']; ?>" />
        <input type="hidden" name="company" value="<?php echo $customer_address['company']; ?>" />
        <input type="hidden" name="country_id" value="<?php echo $customer_address['country_id']; ?>" />
        <input type="hidden" name="firstname" value="<?php echo $customer_address['firstname']; ?>" />
        <input type="hidden" name="lastname" value="<?php echo $customer_address['lastname']; ?>" />
        <input type="hidden" name="postcode" value="<?php echo $customer_address['postcode']; ?>" />
        <input type="hidden" name="zone_id" value="<?php echo $customer_address['zone_id']; ?>" />
    </div>
        ...
        <div class="panel panel-default" style="min-height:195px;">
          ...
          <div class="panel-body">
            <div class="row">
              ...
              <div class="col-md-7">
                <b><a href="javascript:void(0)" style="color: #666;">Saleslogic Admin</a></b>
              </div>
            </div>
            ...
            <div class="row" style="padding-top:5px;">
              <div class="col-md-5 text-right p-r-0">Total (<?php echo $currency['code']; ?>) : </div> 
              <div class="col-md-7"><b><!-- <?php echo $currency['symbol_left']; ?>  --><span id="total" data-currency-symbol="<?php echo $currency['symbol_left']; ?>"><?php echo $currency['symbol_left']; ?> 0.00</span></b></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="panel panel-default" style="min-height:195px;">
          ...
          <div class="panel-body">
            <div class="row">
              ...
              <div class="col-md-7"><b> <?php echo $customer['firstname']; ?></b></div>
            </div>
            <div class="row" style="padding-top:5px;">
            ...
            <div class="row" style="padding-top:5px;">
              ...
              <div class="col-md-7"><b> <?php echo $customer['email']; ?></b></div>
            </div>
            <div class="row" style="padding-top:5px;">
              <div class="col-md-5 text-right p-r-0">Telephone : </div>
              <div class="col-md-7"><b> <?php echo $customer['telephone']; ?></b></div>
            </div>
            <div class="row" style="padding-top:5px;">
        ...
        <div class="panel panel-default" style="min-height:195px;">
          ...
          <div class="panel-body">
            ...
            <div class="row" style="padding-top:5px;">
              ...
              <div class="col-md-7"><b> <?php echo date('d F, Y'); ?></b></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <legend>Add Product</legend>
        ...
        <form>
          <div class="row">
            <div class="col-md-12">
              <div class="row">
                <label class="col-sm-3 text-right">Choose Product</label>
                <div class="col-sm-9 autocomplete-wrapper">
                  <span class="clear-text"></span>
                  <input type="text" id="product-autocomplete" class="form-control" placeholder="Type product name...">
                  <ul style="display:none">
                    ...
                    <li class="add-to-cart"
                      ...
                      data-product-name="<?=$product['name']?>"><?=$product['name']?></li>
                    <?php endforeach; ?>
                  </ul>
                </div>
              </div>
              <div class="row" style="margin-bottom:10px">
                ...
                <div class="col-sm-9">
                  <input type="number" min="1" id="quantity" class="form-control" name="qty" style="max-width:100px">
                </div>
              </div>
              <div class="row" style="margin-bottom:20px">
                <label class="col-sm-3 text-right">&nbsp;</label>
                <div class="col-sm-9">
                  <button type="button" id="addProductBtn" class="btn btn-primary" disabled="disabled">

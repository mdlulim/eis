  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-mproduct" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-pricing" data-toggle="tab">B2B Pricing</a></li>
            ...
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
					...
					<!--new options for product-->
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-video1<?php echo $language['language_id']; ?>">
                            <strong style="color:red">NEW! </strong>
                                <span data-toggle="tooltip" title="<?php echo $help_video1; ?>">
                                <?php echo $entry_video1; ?>
                                </span>
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="product_description[<?php echo $language['language_id']; ?>][video1]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['video1'] : ''; ?>" placeholder="<?php echo $entry_video1; ?>" id="input-video1<?php echo $language['language_id']; ?>" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-tab_title<?php echo $language['language_id']; ?>">
                            <strong style="color:red">NEW! </strong>
                            <span data-toggle="tooltip" title="<?php echo $help_tab_title; ?>">
                                <?php echo $entry_tab_title; ?>
                            </span>
                        </label>
                        <div class="col-sm-10">
                            <input type="text" name="product_description[<?php echo $language['language_id']; ?>][tab_title]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['tab_title'] : ''; ?>" placeholder="<?php echo $entry_tab_title; ?>" id="input-tab_title<?php echo $language['language_id']; ?>" class="form-control" />
                        </div>
                    </div>
                    
                    <!--end custom blocks on product page-->
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-html_product_tab<?php echo $language['language_id']; ?>">
                            <strong style="color:red">NEW! </strong>
                            <span data-toggle="tooltip" title="<?php echo $help_html_product_tab; ?>">
                                <?php echo $entry_html_product_tab; ?>
                            </span>
                        </label>
                        <div class="col-sm-10">
                            <textarea name="product_description[<?php echo $language['language_id']; ?>][html_product_tab]" placeholder="<?php echo $entry_html_product_tab; ?>" id="input-html_product_tab<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['html_product_tab'] : ''; ?></textarea>
                        </div>
                    </div>
					
					<div class="form-group">
                        <label class="col-sm-2 control-label" for="input-html_product_shortdesc<?php echo $language['language_id']; ?>">
                            <strong style="color:red">NEW! </strong>
                            <span data-toggle="tooltip" title="<?php echo $help_html_product_shortdesc; ?>">
                                <?php echo $entry_html_product_shortdesc; ?>
                            </span>
                        </label>
                        <div class="col-sm-10">
							
                            <textarea name="product_description[<?php echo $language['language_id']; ?>][html_product_shortdesc]" placeholder="<?php echo $entry_html_product_shortdesc; ?>" id="input-html_product_shortdesc<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['html_product_shortdesc'] : ''; ?></textarea>
                        </div>
                    </div>
                    <!--new options for product-->
...
$('#input-html_product_tab<?php echo $language['language_id']; ?>').summernote({height: 300});
$('#input-html_product_shortdesc<?php echo $language['language_id']; ?>').summernote({height: 300});
  <?php } ?>
//--></script> 
  <script type="text/javascript"><!--
// Manufacturer
...
$('input[name=\'related\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/mproduct/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',			
			success: function(json) {
				response($.map(json, function(item) {
					return {

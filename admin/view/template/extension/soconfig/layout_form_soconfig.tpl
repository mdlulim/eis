        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-layout" class="form-horizontal">
          ...
          <fieldset>
			<?php global $module_row;$module_row = 0;
				...
				if(isset($layout_route['route']) && ($layout_route['route'])!='mobile/home') :
			 ?>
				...
				<div class="well"> 
					<div class="row">
						<div class="col-md-12 col-sm-12"> 
							<?php echo create_position('Header Top (Used Header 6)','header_top',$layout_modules,$extensions,$module_row); ?>
						</div>
						...
						<div class="col-md-12 col-sm-12"> 
							<?php echo create_position('Header Slide (Used Header 9)','content_slide',$layout_modules,$extensions,$module_row); ?>
						</div>
					 </div>
				</div>
				<?php endif;?>
				...
				<div class="well"> 
					<div class="row">
						<?php if(isset($layout_route['route']) && ($layout_route['route'])!='mobile/home') : ?>
						<div class="col-lg-3 col-md-4 col-sm-12">
							<?php echo create_position('Column Left','column_left',$layout_modules,$extensions,$module_row); ?>
						</div>
						<?php endif;?>
						
						<?php if(isset($layout_route['route'])): ?>
							<?php if(($layout_route['route'])!='mobile/home') : ?>
							...
							<div class="col-sm-12">
								<div class="row">
									<div class="col-sm-12"> 
										<?php echo create_posmobile('Content Mobile','content_mobile',$layout_modules,$extensions,$module_row); ?>
									</div>
				...
				<div class="well"> 
					<div class="row">
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block1 (Used in Footer 1,2,3,4,5)','footer_block1',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block2 (Used in Footer 1)','footer_block2',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block3 (Used in Footer 2,3)','footer_block3',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block4 (Used in Footer 2,3)','footer_block4',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block5 (Used in Footer 5)','footer_block5',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block6 (Used in Footer 5)','footer_block6',$layout_modules,$extensions,$module_row); 

...
<div id="emailtemplate">
	<div class="page-header">
		<div class="container-fluid">
			...
			<h1 class="panel-title"><?php echo $emailtemplate['label']; ?> <small>(<?php echo $emailtemplate['key']; ?>)</small></h1>
			...
			<div class="tab-content">
				...
				<div id="tab-language-<?php echo $langId; ?>" class="tab-pane fade<?php if ($i == 1) { ?> active in<?php } ?>">
					...
					<div class="form-group">
                   		...
                   		<div class="col-sm-10">
                   			<textarea class="summernote" name="emailtemplate_description_comment[<?php echo $langId; ?>]" id="emailtemplate_description_comment_<?php echo $langId; ?>"><?php echo $description['comment']; ?></textarea>
					...
					<?php for ($i = 1; $i <= $content_count; $i++) { ?>
						<?php if ($i < $content_count && empty($description['content'.($i+1)])) $_add_editor_btn = true; ?>
						<div class="emailtemplate_content<?php if ($i != 1 && empty($description['content'.$i])) { ?> hide<?php } ?>">
							<div class="form-group">
                    			<label class="control-label col-sm-2" for="emailtemplate_description_content_<?php echo $i; ?>_<?php echo $langId; ?>">
                    				...
                    				<?php if ($i < $content_count && empty($description['content'.($i+1)]) && ($i == 1 || !empty($description['content'.($i)]))) { ?>
	                    		...
	                    		<div class="col-sm-10">
	                      			<textarea class="summernote" name="emailtemplate_description_content<?php echo $i; ?>[<?php echo $langId; ?>]" id="emailtemplate_description_content<?php echo $i; ?>_<?php echo $langId; ?>"><?php echo $description['content'.$i]; ?></textarea>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <?php if (isset($text_help_subject)) { ?><span class="help-block"><?php echo $text_help_subject; ?></span><?php } ?>
                      </div>
                    </div>
					...
					<div class="panel panel-inbox hide" id="preview-<?php echo $langId; ?>" data-language="<?php echo $langId; ?>" data-store="<?php echo $emailtemplate_config['store_id']; ?>">
						...
						<div class="panel-body">
							<div id="preview-with" class="preview-frame"><i class="fa fa-spinner fa-spin fa-5x" style="color:#009afd"></i></div>
						</div>
					</div>
				</div>
				<?php } ?>
    		...
    		<div class="tab-content panel-tab-default">
				<div id="tab-setting" class="tab-pane fade active in">
										...
										<div class="col-md-6">
											<div class="input-group">
												...
												<span class="input-group-btn">
													<button class="btn btn-default btn-remove-row" type="button"><i class="fa fa-trash"></i></button>
												</span>
											</div>
										</div>
									</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="emailtemplate_config_id" id="emailtemplate_config_id" class="form-control">
								<option value="0"><?php echo $text_select_auto; ?></option>
								<?php foreach($emailtemplate_configs as $row): ?>
								<option value="<?php echo $row['emailtemplate_config_id']; ?>"<?php echo ($emailtemplate['emailtemplate_config_id'] == $row['emailtemplate_config_id']) ? 'selected="selected"' : ''; ?>><?php echo $row['emailtemplate_config_name']; ?></option>
								<?php endforeach; ?>
							</select>
						</div>
					</div>
					...
					<div class="form-group form-group-radio">
						...
						<div class="col-sm-10">
							<input name="emailtemplate_attach_invoice" id="emailtemplate_attach_invoice" class="input-control-checkbox" data-off-label="<?php echo $text_no; ?>" data-on-label="<?php echo $text_yes; ?>" value="1" type="checkbox"<?php echo ($emailtemplate['attach_invoice'] == 1) ? ' checked="checked"' : ''; ?>/>
					...
					<div class="form-group form-group-radio">
						...
						<div class="col-sm-10">
							<input name="emailtemplate_log" id="emailtemplate_log" class="input-control-checkbox" data-off-label="<?php echo $text_default; ?>" data-on-label="<?php echo $text_enabled; ?>" value="1" type="checkbox"<?php echo ($emailtemplate['log'] == 1) ? ' checked="checked"' : ''; ?>/>
						</div>
					</div>

					<div class="form-group form-group-radio">
						<label class="col-sm-2 control-label" for="emailtemplate_mail_queue"><?php echo $entry_mail_queue; ?></label>
						<div class="col-sm-4">
							<input name="emailtemplate_mail_queue" id="emailtemplate_mail_queue" class="input-control-checkbox" data-off-label="<?php echo $text_no; ?>" data-on-label="<?php echo $text_yes; ?>" value="1" type="checkbox"<?php echo ($emailtemplate['mail_queue'] == 1) ? ' checked="checked"' : ''; ?>/>
						</div>
						<label class="col-sm-2 control-label" for="emailtemplate_view_browser"><?php echo $entry_view_browser; ?></label>
						<div class="col-sm-4">
							<input name="emailtemplate_view_browser" id="emailtemplate_view_browser" class="input-control-checkbox" data-off-label="<?php echo $text_default; ?>" data-on-label="<?php echo $text_enabled; ?>" value="1" type="checkbox"<?php echo ($emailtemplate['view_browser'] == 1) ? ' checked="checked"' : ''; ?>/>
						</div>
					</div>

					<div class="form-group form-group-radio">
						<label class="col-sm-2 control-label" for="emailtemplate_showcase"><?php echo $entry_showcase_template; ?></label>
						<div class="col-sm-10">
							<input name="emailtemplate_showcase" id="emailtemplate_showcase" class="input-control-checkbox" data-off-label="<?php echo $text_default; ?>" data-on-label="<?php echo $text_enabled; ?>" value="1" type="checkbox"<?php echo ($emailtemplate['showcase'] == 1) ? ' checked="checked"' : ''; ?>/>
						</div>
					</div>
					...
					<div class="form-group form-group-radio">
						...
						<div class="col-sm-10">
							<input name="emailtemplate_status" id="emailtemplate_status" class="input-control-checkbox" data-off-label="<?php echo $text_disabled; ?>" data-on-label="<?php echo $text_enabled; ?>" value="1" type="checkbox"<?php echo ($emailtemplate['status'] == 1) ? ' checked="checked"' : ''; ?>/>
				...
				<div id="tab-mail" class="tab-pane fade">
					...
					<div class="form-group form-group-radio">
						...
						<div class="col-sm-10">
							<input name="emailtemplate_mail_plain_text" id="emailtemplate_mail_plain_text" class="input-control-checkbox" data-off-label="<?php echo $text_no; ?>" data-on-label="<?php echo $text_yes; ?>" value="1" type="checkbox"<?php echo ($emailtemplate['mail_plain_text'] == 1) ? ' checked="checked"' : ''; ?>/>
						</div>
					</div>
					...
					<div class="form-group form-group-radio">
						...
						<div class="col-sm-10">
							<input name="emailtemplate_mail_html" id="emailtemplate_mail_html" class="input-control-checkbox" data-off-label="<?php echo $text_no; ?>" data-on-label="<?php echo $text_yes; ?>" value="1" type="checkbox"<?php echo ($emailtemplate['mail_html'] == 1) ? ' checked="checked"' : ''; ?>/>
						</div>
					</div>
				...
				<div id="tab-shortcodes" class="tab-pane fade">
					...
					<div class="table-responsive">
						...
						<div class="text-right">
							<a href="<?php echo $action_shortcodes_language; ?>" class="btn btn-default<?php echo ($filter_shortcodes_language) ? ' active' : '' ; ?>"><?php echo $button_language_shortcodes; ?></a>
							<button class="btn btn-danger" data-action="<?php echo $action; ?>&action=delete_shortcode" data-toggle="tooltip" title="<?php echo $button_clear; ?>"><i class="fa fa-trash"></i> <?php echo $button_clear; ?></button>
						</div>
						<?php } ?>
			           	<table class="table table-hover table-row-check" id="shortcodes_list" style="table-layout: fixed;">
			           		<thead>
								<tr>
									<th width="45" class="text-center"><input type="checkbox" data-checkall="input[name^='shortcode_selection']" /></th>
									<th><a href="<?php echo $sort_code; ?>" class="<?php if ($sort == 'code') echo strtolower($order); ?>"><?php echo $column_code; ?></a></th>
			            	...
			            	<tbody>
					            ...
					            <tr>
							        ...
							        <td class="text-center"><a href="javascript:void(0)" class="btn btn-sm btn-default" data-modal="remote" data-url="<?php echo $row['url_edit']; ?>" data-refresh="#shortcodes_list"><i class="fa fa-pencil"></i></a></td>
				            	</tr>
								<?php } ?>
							</tbody>
							<tfoot>
								<tr>
									<td width="1"><button class="btn btn-sm btn-danger" data-confirm="<?php echo $text_confirm; ?>" data-action="<?php echo $action; ?>&action=delete_shortcode" data-toggle="tooltip" title="<?php echo $button_clear; ?>"><i class="fa fa-trash"></i></button></td>
                                    <td colspan="3">&nbsp;</td>
								</tr>
							</tfoot>
						</table>

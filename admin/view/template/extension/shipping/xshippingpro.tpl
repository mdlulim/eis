 ...
 <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="button" id="save_form" form="form-auspost" value="save" name="action" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
             ...
             <div class="row">
                    <div class="col-sm-3">
                      <ul id="method-list" class="nav nav-pills nav-stacked">
                        <li class="active"><a href="#tab-general" class="global" data-toggle="tab"><?php echo $tab_general; ?></a></li>
                        <?php
                            foreach($methods as $no_of_tab=>$name){
                               ?>
                          <li><a class="tab<?php echo $no_of_tab;?>" href="#shipping-<?php echo $no_of_tab; ?>"  data-toggle="tab"><?php echo $name;?></a></li>
                        <?php } ?>
                      </ul>
...
.well-days, .well-desc, .product-category, .product-product, .product-option, .hide-methods{ display:block;}
div.category, div.product, div.option, div.postal-option, div.range-option, div.coupon-option, div.manufacturer-option, div.dimensional-option{ display:none;}
label.any-class {
    margin-top: 4px;
}
...
var range ='<tr>'; 
	...
	range += '    <td class="text-left"><select name="xshippingpro[rate_partial][]"><option __VALUE_PA1__ value="1"><?php echo $text_yes;?></option><option __VALUE_PA2__ value="0"><?php echo $text_no;?></option></select></td>';
...
var tmp='<div id="__ID__" class="tab-pane shipping">'
		   +'<div class="form-group display-name-row">'
                  +'<label class="col-sm-2 control-label" for="input-display__INDEX__"><span data-toggle="tooltip" title="<?php echo addslashes($text_admin_name_tip)?>"><?php echo $text_admin_name; ?> </span></label>'
                  +'<div class="col-sm-10">'
                   +'<input style="width:250px" type="text" name="xshippingpro[display]" value="" class="form-control display-name" id="input-display__INDEX__" />'
          ...
          +'<ul class="nav nav-tabs" id="language__INDEX__">'
            <?php $inc=0; foreach ($languages as $language) { $active_cls=($inc==0)?'class="active"':''; $inc++; ?>
             +'<li <?php echo $active_cls; ?> ><a href="#language<?php echo $language['language_id']; ?>__INDEX__" data-toggle="tab"><img src="<?php echo $language_dir.$language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>'
            <?php } ?>
          +' </ul>'
		  +'<div class="tab-content">'
         <?php $inc=0;foreach ($languages as $language) { $active_cls=($inc==0)?' active':''; $lang_cls=($inc==0)?'':'-lang'; $inc++;  ?>
          +'<div class="tab-pane<?php echo $active_cls;?>" id="language<?php echo $language['language_id']; ?>__INDEX__">'
		    +'<div class="form-group required">'
				+'<label class="col-sm-2 control-label" for="lang-name-__INDEX__<?php echo $language['language_id']; ?>"><span data-toggle="tooltip" title="<?php echo addslashes($text_name_tip)?>"><?php echo $entry_name; ?></span></label>'
				+'<div class="col-sm-10">'
				 +'<input type="text" name="xshippingpro[name][<?php echo $language['language_id']; ?>]" value="" placeholder="<?php echo $entry_name; ?>" id="lang-name-__INDEX__<?php echo $language['language_id']; ?>" class="form-control method-name<?php echo $lang_cls?>" />'
				 +'</div>'
			  +'</div>'
			  +'<div class="form-group">'
				 ...
				 +'<div class="col-sm-10">'
				  +'<input type="text" name="xshippingpro[desc][<?php echo $language['language_id']; ?>]" value="" placeholder="<?php echo $entry_desc; ?>" id="lang-desc-__INDEX__<?php echo $language['language_id']; ?>" class="form-control" />'
				  +'</div>'
			  +'</div>'
	   +'</div>'
	  <?php } ?>
	  +'</div>'
      +'<ul class="nav nav-tabs method-tab" id="method-tab-__INDEX__">'
           ...
           +'<div class="tab-pane active" id="common___INDEX__">'
		        +'<div class="form-group">'
                   ...
                   +'<div class="col-sm-10"><input type="checkbox" name="xshippingpro[inc_weight]" value="1" id="input-weight__INDEX__" /></div>'
                +'</div>'
                +'<div class="form-group">'
                  +'<label class="col-sm-2 control-label" for="input-tax-class__INDEX__"><?php echo $entry_tax; ?></label>'
                  +'<div class="col-sm-10"><select id="input-tax-class__INDEX__" name="xshippingpro[tax_class_id]" class="form-control" >'
                ...
                +'<div class="form-group">'
                  ...
                  +'<div class="col-sm-10"><input type="text" name="xshippingpro[logo]" value="" class="form-control" id="input-logo__INDEX__" /></div>'
                +'</div>'
                +'<div class="form-group">'
                  ...
                  +'<div class="col-sm-10"><input type="text" name="xshippingpro[sort_order]" value="" class="form-control" id="input-sortorder__INDEX__" /></div>'
                +'</div>'
                +'<div class="form-group">'
                  ...
                  +'<div class="col-sm-10"><select class="form-control" id="input-status__INDEX__" name="xshippingpro[status]">'
                  +'<option value="1" selected="selected"><?php echo $text_enabled; ?></option>'
                  +'<option value="0"><?php echo $text_disabled; ?></option>'
                  +'</select></div>'
                +'</div>'
                +'<div class="form-group">'
                  ...
                  +'<div class="col-sm-10"><select class="form-control" id="input-group__INDEX__" name="xshippingpro[group]">'
            ...
            +'<div class="tab-pane" id="criteria___INDEX__">'
               +'<div class="form-group">'
                +'<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo addslashes($tip_store)?>"><?php echo $entry_store; ?></span></label>' 
                 +'<div class="col-sm-10">'
		            +'<label class="any-class"><input checked type="checkbox" name="xshippingpro[store_all]" class="choose-any" value="1" />&nbsp;<?php echo $text_any; ?></label>'
                    ...
                    foreach ($stores as $store) {
                     ?>
		              +'<label>'
                       +'<input type="checkbox" name="xshippingpro[store][]" value="<?php echo $store['store_id']; ?>" /><?php echo addslashes($store['name']); ?>'
		             +'</label>'
                 <?php } ?>
                   +'</div>'
				   +'</div>'
			   ...
			   +'<div class="form-group">'
                +'<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo addslashes($tip_geo)?>"><?php echo $entry_geo_zone; ?></span></label>' 
                 +'<div class="col-sm-10">'
		            +'<label class="any-class"><input checked type="checkbox" name="xshippingpro[geo_zone_all]" class="choose-any" value="1" />&nbsp;<?php echo $text_any; ?></label>'
                    ...
                    foreach ($geo_zones as $geo_zone) {
                     ?>
		              +'<label>'
                       +'<input type="checkbox" name="xshippingpro[geo_zone_id][]" value="<?php echo $geo_zone['geo_zone_id']; ?>" /><?php echo addslashes($geo_zone['name']); ?>'
		             +'</label>'
                 <?php } ?>
                   +'</div>'
				   +'</div>'
               ...
               +'<div class="form-group">'
                +'<label class="col-sm-2 control-label"><?php echo $text_country; ?></label>' 
                 +'<div class="col-sm-10">'
		            +'<label class="any-class"><input checked type="checkbox" name="xshippingpro[country_all]" class="choose-any" value="1" />&nbsp;<?php echo $text_any; ?></label>'
		            ...
		            +'<select class="form-control" multiple="true" size="5" name="xshippingpro[country][]">'
                     <?php 
               ...
               +'</div>'
                ...
                +'<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo addslashes($tip_customer_group)?>"><?php echo $entry_customer_group; ?></span></label>' 
                 +'<div class="col-sm-10">'
		            +'<label class="any-class"><input checked type="checkbox" name="xshippingpro[customer_group_all]" class="choose-any" value="1" />&nbsp;<?php echo $text_any; ?></label>'
		            +'<div class="well well-sm" style="height: 70px; overflow: auto;">'
		             +'<div class="checkbox xshipping-checkbox">'
                     <?php 
                     ...
                     ?>
		              +'<label>'
                       +'<input type="checkbox" name="xshippingpro[customer_group][]" value="<?php echo $customer_group['customer_group_id']; ?>" /><?php echo addslashes($customer_group['name']); ?>'
		             +'</label>'
                 <?php } ?>
                   +'</div>'
				   +'</div>'
               ...
               +'<div class="form-group">'
                +'<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo addslashes($tip_payment)?>"><?php echo $entry_payment; ?></span></label>' 
                 +'<div class="col-sm-10">'
		            +'<label class="any-class"><input checked type="checkbox" name="xshippingpro[payment_all][__INDEX__]" class="choose-any" value="1" />&nbsp;<?php echo $text_any; ?></label>'
		            +'<div class="well well-sm" style="height: 70px; overflow: auto;">'
		             +'<div class="checkbox xshipping-checkbox">'
                     <?php 
                     foreach ($payment_mods as $code=>$value) {
						  if (array_key_exists($code,$xpayments)) {
							   if(!isset($xpayments[$code])) $xpayments[$code]=array();
							   $prefix=$value;
							   foreach($xpayments[$code] as $code =>$value) {
					      ?>
						 +'<label>'
						+'<input type="checkbox" name="xshippingpro[payment][]" value="<?php echo $code; ?>" /><?php echo $prefix.' - '.addslashes($value); ?>'
					  +'</label>'
					   <?php    
							  }
							  continue;
                     ...
                     ?>
		              +'<label>'
                       +'<input type="checkbox" name="xshippingpro[payment][]" value="<?php echo $code; ?>" /><?php echo addslashes($value); ?>'
		             +'</label>'
                 <?php } ?>
                   +'</div>'
				   +'</div>'
			   ...
			   +'<div class="form-group">'
                +'<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo addslashes($tip_manufacturer)?>"><?php echo $entry_manufacturer; ?></span></label>' 
                 +'<div class="col-sm-10">'
		            +'<label class="any-class"><input checked type="checkbox" name="xshippingpro[manufacturer_all]" class="choose-any-with" rel="manufacturer-option" value="1" />&nbsp;<?php echo $text_any; ?></label>'
		            +'<div class="well well-sm" style="height: 100px; overflow: auto;">'
		             +'<div class="checkbox xshipping-checkbox">'
                     <?php 
                    foreach ($manufacturers as $manufacturer) {
                     ?>
		              +'<label>'
                       +'<input type="checkbox" name="xshippingpro[manufacturer][]" value="<?php echo $manufacturer['manufacturer_id']; ?>" /><?php echo addslashes($manufacturer['name']); ?>'
		             +'</label>'
                 <?php } ?>
                   +'</div>'
				   +'</div>'
               ...
               +'</div>'
                ...
                +'<div class="col-sm-10"><select class="form-control" id="input-make-rule__INDEX__" name="xshippingpro[manufacturer_rule]">'
			   ...
			   +'<div class="form-group">'
                +'<label class="col-sm-2 control-label" for="input-postal__INDEX__"><span data-toggle="tooltip" title="<?php echo addslashes($tip_zip)?>"><?php echo $text_zip_postal; ?></span></label>' 
                 +'<div class="col-sm-10">'
		            +'<label class="any-class"><input checked type="checkbox" name="xshippingpro[postal_all]" class="choose-any-with" rel="postal-option" value="1" id="input-postal__INDEX__" /><?php echo $text_any; ?></label>'
	            +'</div>'
               +'</div>'
               +'<div class="form-group postal-option">'
                ...
                +'<div class="col-sm-10"><textarea class="form-control" id="input-zip__INDEX__" name="xshippingpro[postal]" rows="8" cols="70" /></textarea></div>'
               +'</div>'
               +'<div class="form-group postal-option">'
                +'<label class="col-sm-2 control-label" for="input-zip-rule__INDEX__"><?php echo $text_zip_rule?></label>'
                +'<div class="col-sm-10"><select class="form-control" id="input-zip-rule__INDEX__" name="xshippingpro[postal_rule]">'
               ...
               +'</div>'  
                ...
                +'<label class="col-sm-2 control-label" for="input-coupon__INDEX__"><span data-toggle="tooltip" title="<?php echo addslashes($tip_coupon)?>"><?php echo $text_coupon; ?></span></label>' 
                 +'<div class="col-sm-10">'
		            +'<label class="any-class"><input checked type="checkbox" name="xshippingpro[coupon_all]" class="choose-any-with" rel="coupon-option" value="1" id="input-coupon__INDEX__" /><?php echo $text_any; ?></label>'
	            +'</div>'
               +'</div>'
               +'<div class="form-group coupon-option">'
                ...
                +'<div class="col-sm-10"><textarea class="form-control" id="input-coupon-here__INDEX__" name="xshippingpro[coupon]" rows="8" cols="70" /></textarea></div>'
               +'</div>'
               +'<div class="form-group coupon-option">'
                +'<label class="col-sm-2 control-label" for="input-coupon-rule__INDEX__"><?php echo $text_coupon_rule?></label>'
                +'<div class="col-sm-10"><select class="form-control" id="input-coupon-rule__INDEX__" name="xshippingpro[coupon_rule]">'
         ...
         +'<div class="tab-pane" id="catprod___INDEX__">'
	        +'<div class="form-group">'
              ...
              +'<div class="col-sm-10"><select id="input-cat-rule__INDEX__" class="form-control selection" rel="category" name="xshippingpro[category]">'
            ...
            +'</div>'
			 +'<div class="form-group category">'
              ...
              +'<div class="col-sm-10"><select id="input-mul-cat-rule__INDEX__" class="form-control" name="xshippingpro[multi_category]">'
            ...
            +'<div class="form-group">'
              ...
              +'<div class="col-sm-10"><select id="input-product_rule__INDEX__" class="form-control selection" rel="product" name="xshippingpro[product]">'
            ...
            +'</div>'
             +'<div class="form-group">'
              +'<label class="col-sm-2 control-label" for="input-option_rule__INDEX__"><span data-toggle="tooltip" title="<?php echo addslashes($tip_option)?>"><?php echo $text_option; ?></span></label>'
              +'<div class="col-sm-10"><select id="input-option_rule__INDEX__" class="form-control selection" rel="option" name="xshippingpro[option]">'
                  +'<option value="1"><?php echo $text_option_any; ?></option>'
                  +'<option value="6"><?php echo $text_option_least; ?></option>'
                  +'<option value="3"><?php echo $text_option_least_with_other; ?></option>'
	              +'<option value="4"><?php echo $text_option_exact; ?></option>'
	              +'<option value="2"><?php echo $text_option_all; ?></option>'
	              +'<option value="5"><?php echo $text_option_except; ?></option>'
				  +'<option value="7"><?php echo $text_option_except_other; ?></option>'
                +'</select></div>'
             +'</div>'
			  +'<div class="form-group option">'
              +'<label class="col-sm-2 control-label" for="input-option__INDEX__"><?php echo $entry_option; ?></label>'
              +'<div class="col-sm-10"><input type="text" name="option" value="" placeholder="<?php echo $entry_option; ?>" id="input-option__INDEX__" class="form-control" />'
         ...
         +'<div class="tab-pane" id="price___INDEX__">'
            +'<div class="form-group">'
              ...
              +'<div class="col-sm-10"><select id="input-rate__INDEX__" class="rate-selection form-control" name="xshippingpro[rate_type]">'
			...
			+'<div class="form-group dimensional-option">'
             ...
             +'<div class="col-sm-9"><input id="input-dimension_factor__INDEX__" type="text" name="xshippingpro[dimensional_factor]" value="" class="form-control" /></div>'
           +'</div>'
			+'<div class="form-group dimensional-option">'
                +'<label class="col-sm-4 control-label" for="input-dimension_overrule__INDEX__"><?php echo $text_dimensional_overrule; ?></label>'
                +'<div class="col-sm-8"><input id="input-dimension_overrule__INDEX__" type="checkbox" name="xshippingpro[dimensional_overfule]" value="1" /></div>'
            +'</div>'
           +'<div class="form-group single-option">'
             ...
             +'<div class="col-sm-10"><input id="input-cost__INDEX__" class="form-control" type="text" name="xshippingpro[cost]" value="" /></div>'
           +'</div>'
           +'<div class="form-group range-option">'
			...
			+'<div class="form-group range-option">'
             ...
             +'<div class="col-sm-10"><input id="input-additional__INDEX__" class="form-control" type="text" name="xshippingpro[additional]" value="" /></div>'
           +'</div>'
            +'<div class="form-group range-option">'
              ...
              +'<div class="col-sm-10"><select id="input-rate-final__INDEX__" class="form-control" name="xshippingpro[rate_final]">'
            ...
            +'<div class="form-group">'
              ...
              +'<div class="col-sm-10"><select class="form-control" id="input-rate-percent__INDEX__" name="xshippingpro[rate_percent]">'
            ...
            +'<div class="form-group single-option">'
             ...
             +'<div class="col-sm-10"><input id="input-maks__INDEX__" class="form-control" type="text" name="xshippingpro[mask]" value="" /></div>'
           +'</div>'
            +'<div class="form-group range-option">'
                ...
                +'<div class="col-sm-10">'
				    +'<div class="row">'
					   +'<div class="col-sm-4">'
					    +' <input class="form-control" type="text" name="xshippingpro[rate_min]" placeholder="<?php echo $text_price_min?>" value="" />'
					    +'</div>'
						+'<div class="col-sm-4">'
						   +'<input class="form-control" type="text" name="xshippingpro[rate_max]" placeholder="<?php echo $text_price_max?>" value="" />'
						 +'</div>'  
						 +'<div class="col-sm-4">'
						   +'<input class="form-control" type="text" name="xshippingpro[rate_add]" placeholder="<?php echo $text_price_add?>" value="" />'
					    +'</div>'	   
                 +'</div>'
                 +'<div class="row"><div class="col-sm-12"><input type="checkbox" value="1" name="xshippingpro[modifier_ignore]" /><?php echo $ignore_modifier?></div></div>'
                +'</div>'
            +'</div>'
            +'<div class="form-group range-option">'
             ...
             +'<div class="col-sm-10"><textarea class="form-control" id="lang-equation__INDEX__" name="xshippingpro[equation]" rows="8" cols="70" /></textarea><?php echo $text_equation_help;?></div>'
           +'</div>'
		    +'</div>'
           +'<div class="tab-pane" id="other___INDEX__">'
             +'<div class="form-group">'
              ...
              +'<div class="col-sm-10">'
			      +'<div class="well well-sm well-days" style="height: 80px; overflow: auto;">'
				    +'<div class="checkbox xshipping-checkbox">' 
				      +'<label><input name="xshippingpro[days][]" checked type="checkbox" value="0" />&nbsp; <?php echo $text_sunday?></label>'
                    +'<label><input name="xshippingpro[days][]" checked type="checkbox" value="1" />&nbsp; <?php echo $text_monday?></label>'
                    +'<label><input name="xshippingpro[days][]" checked type="checkbox" value="2" />&nbsp; <?php echo $text_tuesday?></label>'
                    +'<label><input name="xshippingpro[days][]" checked type="checkbox" value="3" />&nbsp; <?php echo $text_wednesday?></label>'
                    +'<label><input name="xshippingpro[days][]" checked type="checkbox" value="4" />&nbsp; <?php echo $text_thursday?></label>'
                    +'<label><input name="xshippingpro[days][]" checked type="checkbox" value="5" />&nbsp; <?php echo $text_friday?></label>'
                    +'<label><input name="xshippingpro[days][]" checked type="checkbox" value="6" />&nbsp; <?php echo $text_saturday?></label>'
					 +'</div>'
					+'</div>' 
                +'</div>'
             +'</div>'
            +'<div class="form-group">'
                ...
                +'<div class="col-sm-10">'
				    +'<div class="row">'
					    +'<div class="col-sm-4">'
						   +'<select id="input-time-start__INDEX__" class="form-control" name="xshippingpro[time_start]">'
             ...
             +'<div class="col-sm-10">'
                  +'<div class="row-fluid">'
                     +'<div class="col-sm-5">'
                       +'<input size="15" class="form-control" type="text" name="xshippingpro[order_total_start]" value="" />'
                     +'</div>'
                    +'<div class="col-sm-1"><?php echo $entry_to?></div>'
                    +'<div class="col-sm-5">'
                       +'<input class="form-control" size="15" type="text" name="xshippingpro[order_total_end]" value="" />'
                    +'</div>'
                  +'</div>'
              +'</div>'
           +'</div>'
		   +'<div class="form-group">'
            +'<label class="col-sm-2 control-label" for="input-total__INDEX__"><span data-toggle="tooltip" title="<?php echo addslashes($tip_weight)?>"><?php echo $entry_order_weight?></span></label>'
             +'<div class="col-sm-10">'
                  +'<div class="row-fluid">'
                     +'<div class="col-sm-5">'
                       +'<input size="15" class="form-control" type="text" name="xshippingpro[weight_start]" value="" />'
                     +'</div>'
                    +'<div class="col-sm-1"><?php echo $entry_to?></div>'
                    +'<div class="col-sm-5">'
                       +'<input class="form-control" size="15" type="text" name="xshippingpro[weight_end]" value="" />'
                    +'</div>'
                  +'</div>'
              +'</div>'
           +'</div>'
           ...
           +'<label class="col-sm-2 control-label" for="input-total__INDEX__"><span data-toggle="tooltip" title="<?php echo addslashes($tip_quantity)?>"><?php echo $entry_quantity?></span></label>'
             +'<div class="col-sm-10">'
                  +'<div class="row-fluid">'
                     +'<div class="col-sm-5">'
                       +'<input size="15" class="form-control" type="text" name="xshippingpro[quantity_start]" value="" />'
                     +'</div>'
                    +'<div class="col-sm-1"><?php echo $entry_to?></div>'
                    +'<div class="col-sm-5">'
                       +'<input class="form-control" size="15" type="text" name="xshippingpro[quantity_end]" value="" />'
                    +'</div>'
                  +'</div>'
              +'</div>'
           +'</div>'
           +'<div class="form-group">'
              +'<label class="col-sm-2 control-label" for="input-method__INDEX__"><span data-toggle="tooltip" title="<?php echo addslashes($text_hide_tip)?>"><?php echo $text_hide; ?></span></label>'
              +'<div class="col-sm-10"><input type="text" value="" placeholder="<?php echo $text_hide_placeholder; ?>" id="input-method__INDEX__" class="form-control hide-shipping" />'
 ...
 var auto_complete_prod={
  ...
  var auto_complete_methods={
	 ...
	 'select': function(item) {
		...
		$('.hide-method' + item['value'], my_method_area).remove();
		$('.hide-methods', my_method_area).append('<div class="hide-method' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="xshippingpro[hide][]" value="' + item['value'] + '" /></div>');	
	  }	
  };
...
$(document).ready(function () {		
 ...
 function saveMethod() {
   ...
   if(shipping_methods.length > 0) {
  		...
  		$.ajax({
			url: 'index.php?route=extension/shipping/xshippingpro/quick_save&token=<?php echo $token; ?>&tab_id='+method_data.tab_id,
			dataType: 'json',

...
<div id="content">
				...
				<div class="row">
					...
					<?php // -----------------------------------------------------------------------?>
							...
							<div class="form-group"> 
								<label class="col-sm-3 control-label" for="input-open_link"> <span data-toggle="tooltip" title="Type Layout">Type Layout </span></label>
								<div class="col-sm-9">
									<div class="col-sm-5">
	...
	source: function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/module/so_deals/autocomplete_category&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',

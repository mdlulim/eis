                                    ...
                                    <?php foreach ($modules as $module) { ?>
                                        <div class="tab-pane" id="tab-module<?php echo $module['key']; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                                    <input type="text" name="simple_blog_module[<?php echo $module['key']; ?>][image_width]" value="<?php echo $module['image_width']; ?>" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label">Height of post image</label>
                                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                                    <input type="text" name="simple_blog_module[<?php echo $module['key']; ?>][image_height]" value="<?php echo $module['image_height']; ?>" class="form-control" />
                                                </div>
                                            </div>

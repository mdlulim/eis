	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-featured" data-toggle="tooltip" title="<?php echo $objlang->get('entry_button_save'); ?>" class="btn btn-primary" onclick="$('#action').val('save');$('#form-featured').submit();"><i class="fa fa-save"></i> <?php echo $objlang->get('entry_button_save')?></button>
	...
	<div class="container-fluid">
		...
		<div class="panel panel-default">
			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-featured" class="form-horizontal">
				<div class="panel-body"> <?php // Nav tabs  ?>
					<div class="rows">
					...
					<div class="rows">
						...
						<?php if( $selectedid ){ ?>
						<div class="pull-left">
							<a class="duplicate btn btn-primary" onclick="return duplicateModule(this)" href="<?php echo $action;?>&duplicate=1"><span><i class="fa fa-copy"></i> <?php echo $objlang->get('entry_button_duplicate');?></span></a>
							<a class="remove btn btn-danger" onclick="return deleteModule(this)" href="<?php echo $action;?>&delete=1"><span><i class="fa fa-remove"></i> <?php echo $objlang->get('entry_button_delete');?></span></a>
						</div> <?php //div.pull-left ?>
						<?php } ?>
								...
								<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 text-center">
									...
									<div class="select-import btn-group">
										<select name="import_theme" class="form-control">
											...
											<option value="3"><?php echo $objlang->get('text_theme_furniture'); ?></option>
											<option value="4"><?php echo $objlang->get('text_theme_fashion'); ?></option>
											<option value="5"><?php echo $objlang->get('text_theme_landing'); ?></option>
											<option value="6"><?php echo $objlang->get('text_theme_faq'); ?></option>
											<option value="7"><?php echo $objlang->get('text_theme_pricing'); ?></option>
										</select>
									</div>
									...
									<div class="shortcode-item so-page-widget" data-group="<?php echo $shortcode['group'];?>" data-name="<?php echo $shortcode['name'];?>" data-shortcode="<?php echo $name;?>" data-desc="<?php echo $shortcode['desc'];?>" data-type="shortcode">
										...
										<div class="w-inner">
											...
											<div class="widget-title">
												<p><?php echo $shortcode['name']?></p>
												<span class="widget-title-edit"></span>
											</div>
										</div>
...
<script type="text/javascript">
	...
	var textPreview = "<?php echo $objlang->get('text_java_textPreview');?>";
	var textCol = [];

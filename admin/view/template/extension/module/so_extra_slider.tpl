					...
					<div class="col-sm-12">
						...
						<div  id="tab-module<?php echo $module_row; ?>" class="col-sm-12">
							...
							<div class="tab-pane">
								...
								<?php //--------------------------------------------------------------------------- ?>
									<div class="tab-pane" id="module">  <?php //<!-- General Options --> ?>
										<?php //====Theme Custom Code=====?>
										<?php if(isset($type_layout)):?>
										<div class="form-group"> 
											<label class="col-sm-3 control-label" for="input-open_link"> <span data-toggle="tooltip" title="<?php echo $objlang->get('entry_type_layout'); ?>"><?php echo $objlang->get('Type Layout'); ?> </span></label>
											<div class="col-sm-9">
												<div class="col-sm-5">
										...
										<div class="form-group"> <?php //<!-- Products styles --> ?>
								...
								<?php //--------------------------------------------------------------------------- ?>
									<div class="tab-pane" id="source_option"> <?php //<!-- Source Options --> ?>
										<div class="form-group"> <?php //<!--type data --> ?>
											<label class="col-sm-3 control-label" for="input-type_data"> <span data-toggle="tooltip" title="<?php echo $objlang->get('entry_type_data_desc'); ?>"><?php echo $objlang->get('entry_type_data'); ?></span></label>
											<div class="col-sm-9">
												<div class="col-sm-5">
													<label class="radio-inline">
														<?php if ($module['type_data'] == 'category') { ?>
														<input type="radio" name="type_data" value="category" checked="checked" />
														<?php echo $objlang->get('text_category_data'); ?>
														<?php } else { ?>
														<input type="radio" name="type_data" value="category" />
														<?php echo $objlang->get('text_category_data'); ?>
														<?php } ?>
													</label>
													<label class="radio-inline">
														<?php if ($module['type_data'] == 'product_feature') { ?>
														<input type="radio" name="type_data" value="product_feature" checked="checked" />
														<?php echo $objlang->get('text_product_feature'); ?>
														<?php } else { ?>
														<input type="radio" name="type_data" value="product_feature" />
														<?php echo $objlang->get('text_product_feature'); ?>
														<?php } ?>
													</label>
												</div>
										...
										<div class="form-group input-product_feature" id="input-product_feature_form"> <?php //<!--Product Feature --> ?>
										...
										<div class="form-group input-category">  <?php //<!-- Category --> ?>
										...
										<div class="form-group input-category">  <?php //<!-- Child Category --> ?>
										...
										<div class="form-group input-category" id="input-category_depth_form"> <?php //<!-- Category Depth--> ?>
										...
										<div class="form-group input-category"> <?php //<!-- Product order--> ?>
										...
										<div class="form-group input-category"> <?php //<!-- Ordering--> ?>
								...
								<?php //--------------------------------------------------------------------------- ?>
									<div class="tab-pane" id="product_option"> <?php //<!-- Product Options --> ?>
										...
										<div class="form-group"> <?php //<!-- display readmore link --> ?>
										...
										<div class="form-group"> <?php //<!-- readmore text --> ?>
										...
										<div class="form-group"> <?php //<!-- display add_to_cart --> ?>
										...
										<div class="form-group"> <?php //<!-- display_wishlist_desc --> ?>
										...
										<div class="form-group"> <?php //<!-- display_compare --> ?>
								...
								<?php //--------------------------------------------------------------------------- ?>
									<div class="tab-pane" id="image_option"> <?php //<!-- Image Options --> ?>
								...
								<?php //--------------------------------------------------------------------------- ?>
									<div class="tab-pane" id="effect_option"> <?php //<!-- Effect Options --> ?>
										...
										<div class="form-group"> <?php //<!-- autoplayTimeout --> ?>
										...
										<div class="form-group"> <?php //<!-- autoplayHoverPause --> ?>
										...
										<div class="form-group"> <?php //<!-- autoplaySpeed --> ?>
										...
										<div class="form-group"> <?php //<!-- startPosition --> ?>
										...
										<div class="form-group"> <?php //<!-- mouseDrag --> ?>
										...
										<div class="form-group"> <?php //<!-- touchDrag --> ?>
										...
										<div class="form-group"> <?php //<!-- dotsSpeed --> ?>
										...
										<div class="form-group"> <?php //<!-- navSpeed --> ?>
  ...
  <script type="text/javascript"><!--
	$('input[name=\'category\']').autocomplete({
		source: function(request, response) {
			$.ajax({
				url: 'index.php?route=extension/module/so_extra_slider/autocomplete_category&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
				dataType: 'json',

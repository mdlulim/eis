...
class ControllerMarketingMarketing extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$lastid = $this->model_marketing_marketing->addMarketing($this->request->post);
			...
			$this->response->redirect($this->url->link('marketing/marketing/view', 'token=' . $this->session->data['token'] . '&marketing_id=' . $lastid . $url, true));
		}
		$this->getForm();
	}
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('marketing/marketing/view', 'token=' . $this->session->data['token'] . '&marketing_id=' . $this->request->get['marketing_id'] . $url, true));
		}
		$this->getForm();
	}
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['marketings'][] = array(
				...
				'view'         => $this->url->link('marketing/marketing/view', 'token=' . $this->session->data['token'] . '&marketing_id=' . $result['marketing_id'] . $url, true),
	...
	protected function getForm() {
		...
		if(isset($this->request->get['marketing_id']))
		{
			$data['cancel'] = $this->url->link('marketing/marketing/view', 'token=' . $this->session->data['token'] . '&marketing_id=' . $this->request->get['marketing_id'] . $url, true);
		} else {
	...
	public function view() {
		...
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
		$this->response->setOutput($this->load->view('marketing/marketing_view', $data));
	}

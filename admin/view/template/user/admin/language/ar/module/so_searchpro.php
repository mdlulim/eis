...
$_['heading_title_so']    	= 'So Search Pro <b style="font-size:10px; background:#aaa; color:#fff; padding: 3px;font-weight:normal">version 2.0.1</b>';
...
// Button
$_['button_save_and_edit']      	= 'Save And Stay';

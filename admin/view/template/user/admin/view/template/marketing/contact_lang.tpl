    ...
    <div class="panel form-horizontal" id="language-panel">
      <div class="panel-body">
        <ul class="nav nav-tabs" id="language">
          ...
          <li<?php if($i == 1){ ?> class="active"<?php } ?>><a href="javascript:void(0)" data-target="#language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
          <?php $i++; } ?>
        </ul>
        <div class="tab-content">
          ...
          <div class="tab-pane <?php if($i == 1){ ?> active<?php } ?>" id="language<?php echo $language['language_id']; ?>">
            ...
            <div class="form-group required">
              ...
              <div class="col-sm-10">
                <textarea name="message[<?php echo $language['language_id']; ?>]" id="input-message-<?php echo $language['language_id']; ?>" class="language_editor form-control summernote"></textarea>
              </div>
            </div>
          </div>
          <?php $i++; } ?>
					  ...
					  success: function(json) {
						  for (i in json) {
							  ...
							  if (typeof CKEDITOR !== "undefined" && CKEDITOR.instances["input-message-" + language_id]) {
								  CKEDITOR.instances["input-message-" + language_id].setData(json[i]['emailtemplate']['comment']);
							  } else if ($.fn.summernote) {
								  $("#input-message-" + language_id).summernote('code', json[i]['emailtemplate']['comment']);
							  } else {
								  $("#input-message-" + language_id).val(json[i]['emailtemplate']['comment']);
							  }
						  }
					  }
				  });

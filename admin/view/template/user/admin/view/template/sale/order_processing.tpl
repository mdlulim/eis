...
<div id="content" data-api-key="<?php echo $api_key; ?>" data-catalog="<?php echo $catalog; ?>" data-token="<?php echo $token; ?>" data-quote-id="<?php echo $quote_id; ?>">
    ...
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <div style="float:right;margin-left:8px;">
          <a href="<?php echo $add_order_url; ?>&back=1" data-toggle="tooltip" title="Back" class="btn btn-default" style="float:right;">
            <i class="fa fa-reply"></i>
          </a>
        </div>
        <div style="float:right;margin-left:8px;">
          <a href="<?php echo $cancel_url; ?>" data-toggle="tooltip" id="button-discard" title="<?php echo $button_cancel; ?>" class="btn btn-danger" style="float:right;">

...
('password_link', 'auto', 'http://localhost/index.php?route=account/reset&amp;code=gI6eSKSQprQ3YXPKPeY8qL3YT3BdEAu766SxxEEW', {_ID}),
('account_login', 'auto', 'http://localhost/index.php?route=account/login', {_ID}),
('preheader_preview', 'auto', 'To reset your password click on the link below:', {_ID}),
...
('mail.text', 'auto', 'A new password was requested for Your Store customer account.\n\nTo reset your password click on the link below:\n\nhttp://localhost/index.php?route=account/reset&code=gI6eSKSQprQ3YXPKPeY8qL3YT3BdEAu766SxxEEW\n\nThe IP used to make this request was: localhost\n\n', {_ID}),
...
('text_email', 'language', 'Enter the e-mail address associated with your account. Click submit to have a password reset link e-mailed to you.', {_ID}),
('text_success', 'language', 'An email with a confirmation link has been sent your email address.', {_ID}),
('entry_email', 'language', 'E-Mail Address', {_ID}),
('entry_password', 'language', 'New Password', {_ID}),

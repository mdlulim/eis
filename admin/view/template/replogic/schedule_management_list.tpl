                ...
                <?php if ($schedule_managements) { ?>
                    <?php foreach ($schedule_managements as $schedule_management) { ?>
                            ...
                            <tr>
                              ...
                              <td class="text-right"><a href="<?php echo $schedule_management['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                            </tr>
                     <?php } ?>
                    <?php } else { ?>
                    <tr>

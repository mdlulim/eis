			...
			<div class="panel-body">
				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="tab-export">
						<form action="<?php echo $export; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
						<input type="hidden" name="filter_sku" value="0021" id="filter_sku" class="form-control" />
							...
							<table class="form">
								...
								<tr>
									<td><br /><button type="submit" class="btn btn-primary"><span><?php echo $button_export; ?></span></button></td>
								</tr>
							</table>
						</form>
					</div>

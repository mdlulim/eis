            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-filter" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="sku" value="<?php echo $price_info['sku']; ?>" placeholder="<?php echo $entry_sku; ?>" id="input-sort-order" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-contract"><?php echo $entry_contract; ?></label>
                        <div class="col-sm-10">
                            <select name="customer_group_id" id="input-contract" class="form-control">
                                <?php foreach ($customer_groups as $_customer_groups) { ?>
                                <?php if ($_customer_groups['customer_group_id'] == $price_info['contract_id']) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="price" value="<?php echo $price_info['price']; ?>" placeholder="<?php echo $entry_price; ?>" id="input-sort-order" class="form-control" />
                        </div>
                    </div>
                </form>
            </div>

...
$_['heading_title_so']    = 'So Deals <b style="font-size:10px; background:#aaa; color:#fff; padding: 3px;font-weight:normal">version 2.1.0</b>';
...
$_['entry_item_created_display']  		= 'Display Created Date';
$_['entry_item_created_display_desc']  	= 'Allow to show/hide created for product';

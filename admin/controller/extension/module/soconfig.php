...
class ControllerExtensionModuleSoconfig extends Controller {
	...
	public function  __construct($registry) {
		...
		$this->demos = array(
			...
			array('key'=>'layout6', 'title'=>'Home Layout6','link'=>'#'),
			array('key'=>'layout7', 'title'=>'Home Layout7','link'=>'#'),
			array('key'=>'layout8', 'title'=>'Home Layout8','link'=>'#'),
			array('key'=>'layout9', 'title'=>'Home Layout9','link'=>'#'),
			array('key'=>'layout10', 'title'=>'Home Layout10','link'=>'#'),
			array('key'=>'layout11', 'title'=>'Home Layout11','link'=>'#'),
			array('key'=>'layout12', 'title'=>'Home Layout12','link'=>'#'),
		...
		$this->typelayouts = array(
			...
			array(
			'key'=>'2',
			'typelayout'=>'<p>Layout 2</p> <p class="font-small">(Header - Type 2,Footer - Type 1)</p>',
			'typeheader'=> array('key'=>'2', 'title'=>'Header 2 (used in Layout 2)'),
			'typefooter'=> array('key'=>'1', 'title'=>'Footer 1 (used in Layout 1)'),
			),
			array(
			'key'=>'3',
			'typelayout'=>'<p>Layout 3 </p><p class="font-small">(Header - Type 3,Footer - Type 1)</p>',
			'typeheader'=> array('key'=>'3', 'title'=>'Header 3 (used in Layout 3)'),
			'typefooter'=> array('key'=>'1', 'title'=>'Footer 1 (used in Layout 1)'),
			),
			array(
			'key'=>'4',
			'typelayout'=>'<p>Layout 4</p> <p class="font-small">(Header - Type 4,Footer - Type 1)</p>',
			'typeheader'=> array('key'=>'4', 'title'=>'Header 4 (used in Layout 4)'),
			'typefooter'=> array('key'=>'1', 'title'=>'Footer 1 (used in Layout 1)'),
			),
			array(
			'key'=>'5',
			'typelayout'=>'<p>Layout 5</p> <p class="font-small">(Header - Type 5,Footer - Type 2)</p>',
			'typeheader'=> array('key'=>'5', 'title'=>'Header 5 (used in Layout 5)'),
			'typefooter'=> array('key'=>'2', 'title'=>'Footer 2 (used in Layout 5)'),
			),
			array(
			'key'=>'6',
			'typelayout'=>'<p>Layout 6</p> <p class="font-small">(Header - Type 6,Footer - Type 3)</p>',
			'typeheader'=> array('key'=>'6', 'title'=>'Header 6 (used in Layout 6)'),
			'typefooter'=> array('key'=>'3', 'title'=>'Footer 3 (used in Layout 6)'),
			),
			array(
			'key'=>'7',
			'typelayout'=>'<p>Layout 7</p> <p class="font-small">(Header - Type 7,Footer - Type 4)</p>',
			'typeheader'=> array('key'=>'7', 'title'=>'Header 7 (used in Layout 7)'),
			'typefooter'=> array('key'=>'4', 'title'=>'Footer 4 (used in Layout 7)'),
			),
			array(
			'key'=>'8',
			'typelayout'=>'<p>Layout 8</p> <p class="font-small">(Header - Type 8,Footer - Type 5)</p>',
			'typeheader'=> array('key'=>'8', 'title'=>'Header 8 (used in Layout 8)'),
			'typefooter'=> array('key'=>'5', 'title'=>'Footer 5 (used in Layout 8)'),
			),
			array(
			'key'=>'9',
			'typelayout'=>'<p>Layout 9</p> <p class="font-small">(Header - Type 9,Footer - Type 1)</p>',
			'typeheader'=> array('key'=>'9', 'title'=>'Header 9 (used in Layout 9)'),
			'typefooter'=> array('key'=>'1', 'title'=>'Footer 1'),
			),
			array(
			'key'=>'10',
			'typelayout'=>'<p>Layout 10</p> <p class="font-small">(Header - Type 10,Footer - Type 1)</p>',
			'typeheader'=> array('key'=>'10', 'title'=>'Header 10 (used in Layout 10)'),
			'typefooter'=> array('key'=>'1', 'title'=>'Footer 1'),
			),
			array(
			'key'=>'11',
			'typelayout'=>'<p>Layout 11</p> <p class="font-small">(Header - Type 11,Footer - Type 1)</p>',
			'typeheader'=> array('key'=>'11', 'title'=>'Header 11 (used in Layout 11)'),
			'typefooter'=> array('key'=>'1', 'title'=>'Footer 1'),
			),
			array(
			'key'=>'12',
			'typelayout'=>'<p>Layout 12</p> <p class="font-small">(Header - Type 12,Footer - Type 1)</p>',
    ...
    public function index() {
		...
		else $this->document->addStyle('view/stylesheet/theme-rtl.css');
			...
			foreach($stores as $storeid => $store){
				...
				if(!empty($load_config) ){
					foreach ($load_config as $conf_name => $conf_value){
						...
						if(isset($conf_value[$store['store_id']])){
							$data[$conf_name][$store['store_id']] = $conf_value[$store['store_id']];
						}else{
							$data[$conf_name][$store['store_id']] = '';
						}
		...
		foreach($store_data as  $store){
			if($store['status']){
				...
				$imgpreloader 	= isset($data['soconfig_general_store'][$store['store_id']]['imgpreloader']) ? $data['soconfig_general_store'][$store['store_id']]['imgpreloader'] : '';
				...
				if($this->soconfig !=null){
						$data['allThemeColor'][$store['store_id']] =  $this->soconfig->getColorScheme($typelayout);
					}else{
						echo 'Changes: Go to Extensions > Modifications and click on the Blue Refresh button to apply changes.';exit;
				}
				...
				if (is_file(DIR_IMAGE.$imgpreloader)) {
					$data['imgpreloader'][$store['store_id']] = $this->model_tool_image->resize($imgpreloader, 100, 100);
				} else {
					$data['imgpreloader'][$store['store_id']] = $this->model_tool_image->resize('no_image.png', 100, 100);
				}
			}
		}

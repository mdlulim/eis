...
class ControllerExtensionModuleSohomeslider extends Controller {
	...
	// Delete Module
		if( isset($this->request->get['slide_id']) && isset($this->request->get['module_id']) && isset($this->request->get['delete']) ){
			...
			$this->response->redirect($this->url->link('extension/module/so_home_slider', 'token=' . $this->session->data['token'].'&tab=slide&module_id='.$this->request->get['module_id'], 'SSL'));
			...
			$this->response->redirect($this->url->link('extension/module/so_home_slider', 'token=' . $this->session->data['token'], 'SSL'));
		}
	// Get Module Id New
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if($tab_module == 'add-slide' || $tab == 'slide' && $tab_module != 'add-module')
			{
				...
				if($action == "save_edit") {
					$this->response->redirect($this->url->link('extension/module/so_home_slider', 'module_id='.$this->request->get['module_id'].'&tab=slide&slide_id='.$slide_id.'&token=' . $this->session->data['token'], 'SSL'));
				...
				if (!isset($this->request->get['module_id'])) {
					...
					$this->model_extension_module->addModule('so_home_slider', $this->request->post);
				...
				if($action == "save_edit") {
					$this->response->redirect($this->url->link('extension/module/so_home_slider', 'module_id='.$module_id.'&token=' . $this->session->data['token'], 'SSL'));
				}elseif($action == "save_new"){
					$this->response->redirect($this->url->link('extension/module/so_home_slider', 'token=' . $this->session->data['token'], 'SSL'));
				}else{
					$this->response->redirect($this->url->link('extension/extension', 'token=' . $this->session->data['token'], 'SSL'));
		...
		if (isset($this->request->get['module_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST') || ($this->request->server['REQUEST_METHOD'] == 'POST' && !$this->validate() && isset($this->request->get['module_id'])) || ($this->request->server['REQUEST_METHOD'] == 'POST' && !$this->validate() && isset($this->request->get['slide_id']))) {
			...
			$data['action'] 				= $this->url->link('extension/module/so_home_slider', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');
			
			if(isset($this->request->get['slide_id'])){
				$data['action'] = $this->url->link('extension/module/so_home_slider', 'token=' . $this->session->data['token'] . '&tab=slide&module_id='.$this->request->get['module_id'].'&slide_id=' . $this->request->get['slide_id'], 'SSL');
				
			}elseif(isset($this->request->get['tab']) && $this->request->get['tab'] == "slide")
			{
				$data['action'] = $this->url->link('extension/module/so_home_slider', 'token=' . $this->session->data['token'] . '&tab=slide&module_id='.$this->request->get['module_id'], 'SSL');
			}
			...
			$data['selectedid'] 	= 0;
			$data['action'] 		= $this->url->link('extension/module/so_home_slider', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['moduletabs'] = $this->model_extension_module->getModulesByCode( 'so_home_slider' );
		$data['link'] = $this->url->link('extension/module/so_home_slider', 'token=' . $this->session->data['token'] . '', 'SSL');
		$data['linkremove'] = $this->url->link('extension/module/so_home_slider&token=' . $this->session->data['token']);
		//--------------------------------Load Data -------------------------------------------
	...
	public function _breadcrumbs(){
		...
		if (!isset($this->request->get['module_id'])) {
			$this->data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('extension/module/so_home_slider', 'token=' . $this->session->data['token'], 'SSL')
			);
		} else {
			$this->data['breadcrumbs'][] = array(
				'text' => $this->language->get('heading_title'),
				'href' => $this->url->link('extension/module/so_home_slider', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL')
			);
		}

...
class ControllerExtensionModuleSeoUrls extends Controller {
	...
	public function index() {   
		...
		$data['action'] = $this->url->link('extension/module/seo_urls', 'token=' . $this->session->data['token'], true);
		...
		foreach ($seo_urls_db->rows as $seo_url) {
			...
			$url_delete = $this->url->link('extension/module/seo_urls/delete', 'token=' . $this->session->data['token'] . $url_delete, 'SSL');
		...
		$this->response->setOutput($this->load->view('extension/module/seo_urls.tpl', $data));
	}
	...
	public function delete() {
		...
		if (isset($this->request->get['ulr_id']) && $this->validateDelete()) {
			...
			$this->response->redirect($this->url->link('extension/module/seo_urls', 'token=' . $this->session->data['token'], 'SSL'));
		}
		$this->index();
	}

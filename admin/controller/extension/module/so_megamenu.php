...
class ControllerExtensionModuleSoMegaMenu extends Controller {
    ...
    public function index() {
        ...
        $this->load->model('extension/module');
		 ...
		 if ($data['direction'] != 'rtl') $this->document->addStyle('view/javascript/so_megamenu/so_megamenu.css');
		 else $this->document->addStyle('view/javascript/so_megamenu/so_megamenu-rtl.css');
		...
		$data['text_suffix_class'] = $this->language->get('text_suffix_class');
		...
		$data['moduletabs'] = $this->model_extension_module->getModulesByCode('so_megamenu');
		$data['link_add'] = $this->url->link('extension/module/so_megamenu', 'token=' . $this->session->data['token'] . '', 'SSL');
        ...
        if(isset($_GET['delete'])) {
            ...
            $this->response->redirect(HTTPS_SERVER . 'index.php?route=extension/module/so_megamenu&token=' . $this->session->data['token'].'&action=create&module_id='.$this->request->get['module_id']);
        }
            ...
            if(isset($_POST['button-create'])) {
                if($this->validate()) {
                    ...
                    if($error == true) {
						...
						if(array_key_exists('category',$this->request->post['content']['subcategory'])){
							if((isset($this->request->post['content']['subcategory']['category'])) && ($this->request->post['content']['subcategory']['category'])) $this->request->post['content']['subcategory']['category'] = serialize ($this->request->post['content']['subcategory']['category']);	
							else $this->request->post['content']['subcategory']['category'] ='';
						}
                ...
                $this->response->redirect(HTTPS_SERVER . 'index.php?route=extension/module/so_megamenu&token=' . $this->session->data['token']);
            }
        }		
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            if(isset($_POST['button-back'])) {
				$this->response->redirect(HTTPS_SERVER . 'index.php?route=extension/module/so_megamenu&token=' . $this->session->data['token'].'&module_id='.$this->request->get['module_id']);
			}	
            ...
            elseif(isset($_POST['button-edit'])) {
                if($this->validate()) {
                    ...
                    if($error == true) {
						...
						if($this->request->post['link'])
							$this->request->post['link'] = serialize ($this->request->post['link']);
						if(isset($this->request->post['content']['subcategory']['category']))
                        ...
                        $this->session->data['success'] = $this->language->get('text_success');
						$this->response->redirect(HTTPS_SERVER . 'index.php?route=extension/module/so_megamenu&token=' . $this->session->data['token'].'&edit='.$this->request->post['id'].'&module_id='.$this->request->get['module_id']);
                    }
                } else {
                    $this->session->data['error_warning'] = $this->language->get('error_permission');
                }
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            if(isset($_POST['button-save'])){
				...
				if (!isset($this->request->get['module_id'])) {
					...
					$this->model_extension_module->addModule('so_megamenu', $this->request->post);	
				} else {
                ...
                $this->session->data['success'] = $this->language->get('text_success');
				$this->response->redirect($this->url->link('extension/module/so_megamenu', 'module_id='.$module_id.'&token=' . $this->session->data['token'], 'SSL'));
			}
        }
		...
		if (!isset($this->request->get['module_id'])) {
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('extension/module/so_megamenu', 'token=' . $this->session->data['token'], 'SSL')
			);
		} else {
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('heading_title'),
				'href' => $this->url->link('extension/module/so_megamenu', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL')
			);
		}	

		$this->load->model('extension/module');
		$data['modules'] = $this->model_extension_module->getModulesByCode('so_megamenu');
		if (isset($this->request->post['head_name'])) {
		...
		if (isset($this->request->post['suffix_class'])) {
            $data['suffix_class'] = $this->request->post['suffix_class'];
        } elseif (!empty($module_info)) {
            $data['suffix_class'] = $module_info['suffix_class'];
        } else {
            $data['suffix_class'] = '';
        }
        ...
        if (!isset($this->request->get['module_id'])) {
            $data['action'] = $this->url->link('extension/module/so_megamenu', 'token=' . $this->session->data['token'], 'SSL');
			$data['selectedid'] = 0;       
	   } else {
            $data['action'] = $this->url->link('extension/module/so_megamenu', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');			
        ...
        {
            $this->model_extension_module_so_megamenu->duplicateMenu($_GET['duplicate']);
            $this->response->redirect(HTTPS_SERVER . 'index.php?route=extension/module/so_megamenu&token=' . $this->session->data['token'].'&action=create&module_id='.$this->request->get['module_id']);
        }
        ...
        $data['linkremove'] = $this->url->link('extension/module/so_megamenu&token=' . $this->session->data['token']);

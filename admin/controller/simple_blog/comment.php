    ...
    class ControllerSimpleBlogComment extends Controller {
		...
		public function insert() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validateForm())) {
				...
				$this->response->redirect($this->url->link('simple_blog/comment', 'token=' . $this->session->data['token'] . $url, true));				
			}
		...
		public function getList() {
			...
			$data['breadcrumbs'] = array();
	   		...
	   		$data['breadcrumbs'][] = array(
				...
				'href'      => $this->url->link('simple_blog/comment', 'token=' . $this->session->data['token'] . $url, true),
	      		'separator' => ' :: '
	   		);
			
			$data['insert'] = $this->url->link('simple_blog/comment/insert', 'token=' . $this->session->data['token'] . $url, true);
			$data['delete'] = $this->url->link('simple_blog/comment/delete', 'token=' . $this->session->data['token'] . $url, true);
			...
			foreach($results as $result) {
				$data['comments'][] = array(
					...
					'edit'          	=> $this->url->link('simple_blog/comment/update', 'token=' . $this->session->data['token'] . '&simple_blog_comment_id=' . $result['simple_blog_comment_id'] . $url, true)
				);		
			}
			...
			$data['sort_article_title'] = $this->url->link('simple_blog/comment', 'token=' . $this->session->data['token'] . '&sort=sbad.article_title' . $url, true);
			$data['sort_author_name'] = $this->url->link('simple_blog/comment', 'token=' . $this->session->data['token'] . '&sort=sbc.name' . $url, true);
			$data['sort_status'] = $this->url->link('simple_blog/comment', 'token=' . $this->session->data['token'] . '&sort=sbc.status' . $url, true);
			$data['sort_date_added'] = $this->url->link('simple_blog/comment', 'token=' . $this->session->data['token'] . '&sort=sbc.date_added' . $url, true);
			...
			$pagination->url = $this->url->link('simple_blog/comment', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
    		...
    		$this->response->setOutput($this->load->view('simple_blog/comment_list', $data));
		}		
		...
		public function getForm() {
			...
			if (!isset($this->request->get['simple_blog_comment_id'])) {
				$data['action'] = $this->url->link('simple_blog/comment/insert', 'token=' . $this->session->data['token'] . $url, true);
			} else {
				$data['action'] = $this->url->link('simple_blog/comment/update', 'token=' . $this->session->data['token'] . '&simple_blog_comment_id=' . $this->request->get['simple_blog_comment_id'] . $url, true);
			}
			
			$data['cancel'] = $this->url->link('simple_blog/comment', 'token=' . $this->session->data['token'] . $url, true);
            ...
            $this->response->setOutput($this->load->view('simple_blog/comment_form', $data));
		}

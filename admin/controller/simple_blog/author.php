	...
	class ControllerSimpleBlogAuthor extends Controller {		
		...
		public function insert() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				...
				$this->response->redirect($this->url->link('simple_blog/author', 'token=' . $this->session->data['token'] . $url, true));
			}
		...
		public function getList() {
			...
			$data['breadcrumbs'][] = array(
				...
				'href'      => $this->url->link('simple_blog/author', 'token=' . $this->session->data['token'] . $url, true),
				'separator' => ' :: '
			);
			
			$data['insert'] = $this->url->link('simple_blog/author/insert', 'token=' . $this->session->data['token'] . $url, true);
			$data['delete'] = $this->url->link('simple_blog/author/delete', 'token=' . $this->session->data['token'] . $url, true);
			...
			foreach($results as $result) {
				...
				$data['authors'][] = array(
					...
					'edit'          	=> $this->url->link('simple_blog/author/update', 'token=' . $this->session->data['token'] . '&simple_blog_author_id=' . $result['simple_blog_author_id'] . $url, true)
				);				
			}		
			...
			$data['sort_name'] = $this->url->link('simple_blog/author', 'token=' . $this->session->data['token'] . '&sort=sba.name' . $url, true);
			$data['sort_status'] = $this->url->link('simple_blog/author', 'token=' . $this->session->data['token'] . '&sort=sba.status' . $url, true);
			$data['sort_date_added'] = $this->url->link('simple_blog/author', 'token=' . $this->session->data['token'] . '&sort=sba.date_added' . $url, true);
			...
			$pagination->url = $this->url->link('simple_blog/author', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
    		...
    		$this->response->setOutput($this->load->view('simple_blog/author_list', $data));
		}		
		...
		public function getForm() {
			...
			if (!isset($this->request->get['simple_blog_author_id'])) {
				$data['action'] = $this->url->link('simple_blog/author/insert', 'token=' . $this->session->data['token'] . $url, true);
			} else {
				$data['action'] = $this->url->link('simple_blog/author/update', 'token=' . $this->session->data['token'] . '&simple_blog_author_id=' . $this->request->get['simple_blog_author_id'] . $url, true);
			}
			
			$data['cancel'] = $this->url->link('simple_blog/author', 'token=' . $this->session->data['token'] . $url, true);
            ...
            $this->response->setOutput($this->load->view('simple_blog/author_form', $data));
		}

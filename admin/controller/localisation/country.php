...
class ControllerLocalisationCountry extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$lastid = $this->model_localisation_country->addCountry($this->request->post);
			...
			$this->response->redirect($this->url->link('localisation/country/view', 'token=' . $this->session->data['token'] . '&country_id=' . $lastid . $url, true));
		}
		$this->getForm();
	}
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('localisation/country/view', 'token=' . $this->session->data['token'] . '&country_id=' . $this->request->get['country_id'] . $url, true));
		}
		$this->getForm();
	}
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['countries'][] = array(
				...
				'view'       => $this->url->link('localisation/country/view', 'token=' . $this->session->data['token'] . '&country_id=' . $result['country_id'] . $url, true),
				'edit'       => $this->url->link('localisation/country/edit', 'token=' . $this->session->data['token'] . '&country_id=' . $result['country_id'] . $url, true)
			);
		}
		$data['Dropdownnames'] = $this->model_localisation_country->getCountries();
	...
	protected function getForm() {
		...
		if(isset($this->request->get['country_id']))
		{
			$data['cancel'] = $this->url->link('localisation/country/view', 'token=' . $this->session->data['token'] . '&country_id=' . $this->request->get['country_id'] . $url, true);
		} else {
	...
	public function view() {
		...
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
		$this->response->setOutput($this->load->view('localisation/country_view', $data));
	}

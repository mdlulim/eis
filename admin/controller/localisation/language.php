...
class ControllerLocalisationLanguage extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$lastid = $this->model_localisation_language->addLanguage($this->request->post);
			...
			$this->response->redirect($this->url->link('localisation/language/view', 'token=' . $this->session->data['token'] . '&language_id=' . lastid . $url, true));
		}
		$this->getForm();
	}
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('localisation/language/view', 'token=' . $this->session->data['token'] . '&language_id=' . $this->request->get['language_id'] . $url, true));
		}
		$this->getForm();
	}
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['languages'][] = array(
				...
				'view'        => $this->url->link('localisation/language/view', 'token=' . $this->session->data['token'] . '&language_id=' . $result['language_id'] . $url, true),
	...
	protected function getForm() {
		...
		if(isset($this->request->get['language_id']))
		{
			$data['cancel'] = $this->url->link('localisation/language/view', 'token=' . $this->session->data['token'] . '&language_id=' . $this->request->get['language_id'] . $url, true);
		} else { 
	...
	public function view() {
		...
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
		$this->response->setOutput($this->load->view('localisation/language_view', $data));
	}

...
class ControllerReportSaleTax extends Controller {
	public function index() {
		...
		$pagination->url = $this->url->link('report/sale_tax', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('report/sale_tax_new', $data));
	}
}
<?php
	class ModelSimpleBlogCategory extends Model {
		...
		public function addCategory($data) {
			...
			if ($data['keyword']) {
				$this->db->query("INSERT INTO `" . DB_PREFIX . "url_alias` SET query = 'simple_blog_category_id=" . (int)$simple_blog_category_id . "', keyword = '" . $this->db->escape($data['keyword']) . "'");
			}
		...
		public function editCategory($simple_blog_category_id, $data) {
			...
			$this->db->query("DELETE FROM `" . DB_PREFIX . "url_alias` WHERE query = 'simple_blog_category_id=" . (int)$simple_blog_category_id. "'");
		...
		public function getCategory($simple_blog_category_id) {
			$query = $this->db->query("SELECT DISTINCT *, (SELECT keyword FROM " . DB_PREFIX . "url_alias WHERE query = 'simple_blog_category_id=" . (int)$simple_blog_category_id . "') AS keyword FROM `" . DB_PREFIX . "simple_blog_category` WHERE simple_blog_category_id = '" . (int)$simple_blog_category_id . "'");		
			return $query->row;
		}		

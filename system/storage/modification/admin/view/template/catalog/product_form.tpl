...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <h1>Test<?php echo $heading_title; ?></h1>
      <ul class="breadcrumb">
      ...
      <?php } ?>
        ...
        <?php } ?>
                  ...
                  <tfoot>
                    <tr>
                      <td colspan="2"></td>
                      <td class="text-left"><?php if ($pim_status){?><a type="button" data-toggle="manager" title="<?php echo 'Power Image Manager'; ?>" class="btn btn-success"><i class="fa fa-upload"></i> <?php echo 'Power Image Manager'; ?></a>&nbsp;<?php } ?><button type="button" onclick="addImage();" data-toggle="tooltip" title="<?php echo $button_image_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                    </tr>
                  </tfoot>
                </table>
              </div>

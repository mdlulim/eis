	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<?php if ($install) { ?><button type="submit" form="form-account" class="btn btn-success"><i class="fa fa-plus"></i><span class="hidden-xs hidden-sm"> <?php echo $button_install; ?></span></button><?php } ?>

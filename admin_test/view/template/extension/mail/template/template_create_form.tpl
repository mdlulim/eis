	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button id="submit_form_button" type="submit" form="form-emailtemplate" data-toggle="tooltip" title="Save" class="btn btn-primary"><i class="fa fa-save"></i></button>
			...
			<div class="panel-body">
				<div class="form-group required">
					...
					<div class="col-sm-5">
						...
						<span class="help-block" style="margin-bottom: 0"><?php echo $text_help_template_key; ?></span>
					</div>
					<div class="col-sm-5">

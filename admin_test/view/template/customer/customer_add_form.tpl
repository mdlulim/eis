                  ...
                  <ul class="nav nav-pills nav-stacked" id="address">
                    ...
                    <li <?php echo $df; ?> >
                      <a href="#tab-address<?php echo $address_row; ?>" data-toggle="tab">
                        <i class="fa fa-minus-circle" onclick="$('#address a:first').tab('show'); $('#address-add').show(); $('#address a[href=\'#tab-address<?php echo $address_row; ?>\']').parent().remove(); <?php if ($address_row <> 1) :?>$('#tab-address<?php echo $address_row; ?>').remove(); <?php endif; ?>"></i> <?php echo $tab_address . ' ' . $address_row; ?>
                      </a>
                    </li>
                    <?php $address_row++; ?>
                    <?php } ?>

                      ...
                      <?php if (isset($error_customer_contact[$address_row]['first_name']) || isset($error_customer_contact[$address_row]['last_name']) || isset($error_customer_contact[$address_row]['email']) || isset($error_customer_contact[$address_row]['telephone_number']) || isset($error_customer_contact[$address_row]['cellphone_number'])) { ?>
                        <a style="color:#f56b6b;" href="#tab-address<?php echo $address_row; ?>" data-toggle="tab">
                           <?php if ($customer_contact['first_name']=='') { ?>
                              <i class="fa fa-minus-circle" onclick="confirm('<?php echo $text_confirm; ?>') ? delt(<?php echo $customer_contact['customer_con_id']; ?>,<?php echo $customer_id; ?>) : false;"></i><?php echo 'Customer Contact ';?> <?php echo $address_row; ?>
                             <?php } else { ?>
                                <i class="fa fa-minus-circle" onclick="confirm('<?php echo $text_confirm; ?>') ? delt(<?php echo $customer_contact['customer_con_id']; ?>,<?php echo $customer_id; ?>) : false;"></i><?php echo $customer_contact['first_name'].' '.$customer_contact['last_name']; ?>
                                    <?php } ?>
                         </a>
                        <?php } else { ?>

            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'task_name') { ?>
                    <a href="<?php echo $sort_task_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_task_name; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_task_name; ?>"><?php echo $column_task_name; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <?php if ($tasks) { ?>
                    <?php foreach ($tasks as $task) {  ?>
                            ...
                            <tr>
                              <td class="text-center"><?php if (in_array($note['task_id'], $selected)) { ?>
                              ...
                              <td class="text-left"><?php echo $task['salesrep']; ?></td>
                    ...
                    <?php } else { ?>
                    <tr>
                      <td class="text-center" colspan="5">No any Appointment Tasks Available</td>
                    </tr>
                    <?php } ?>
                <?php } else { ?>
                	<tr>
                        <td class="text-center" colspan="5">You Don't have Permission to access the Appointment Tasks.</td>
                    </tr>
                <?php } ?>
              </tbody>
            </table>

...
<div class="module-header">
    <div class='module-name'>Blog Search<span data-ng-show="module_id == null">New Module</span><span data-ng-show="module_id != null">Edit Module</span></div>
    ...
    <accordion close-others="module_data.close_others">
        <accordion-group is-open="module_data.general_is_open">
            ...
            <ul class="module-create-options">
                ...
                <li>
                    <span class="module-create-title">Placeholder</span>
                    <span class="module-create-option">
                        <j-opt-text-lang data-ng-model="module_data.placeholder"></j-opt-text-lang>
                    </span>
                </li>
            </ul>
        </accordion-group>

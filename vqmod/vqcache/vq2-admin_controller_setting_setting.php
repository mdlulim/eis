...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_stock_warning'] = $this->language->get('entry_stock_warning');
                 ...
                 $data['help_update_category_customer_groups_in_category_list'] = $this->language->get('help_update_category_customer_groups_in_category_list');
		 		 ...
		 		 $data['entry_show_admin_product_customer_group_prices_in_product_list'] = $this->language->get('entry_show_admin_product_customer_group_prices_in_product_list');
                 $data['text_products_by_customer_group_prices'] = $this->language->get('text_products_by_customer_group_prices');
                 $data['entry_update_product_customer_group_prices_in_product_list'] = $this->language->get('entry_update_product_customer_group_prices_in_product_list');
                 $data['entry_enable_admin_product_customer_group_prices'] = $this->language->get('entry_enable_admin_product_customer_group_prices');
                 $data['help_update_product_customer_group_prices_in_product_list'] = $this->language->get('help_update_product_customer_group_prices_in_product_list');
                 $data['help_enable_admin_product_customer_group_prices'] = $this->language->get('help_enable_admin_product_customer_group_prices');
		...
		if (isset($this->request->post['config_logo']) && is_file(DIR_IMAGE . $this->request->post['config_logo'])) {
			...
			$data['logo'] = $this->model_tool_image->resize('tsc_image.png', 100, 100);
		}
		...
		if (isset($this->request->post['config_icon']) && is_file(DIR_IMAGE . $this->request->post['config_icon'])) {
			...
			$data['icon'] = $this->model_tool_image->resize('tsc_image.png', 100, 100);
		}
	...
	public function theme() {
		...
		if (is_file(DIR_CATALOG . 'view/theme/' . $theme . '/image/' . $theme . '.png')) {
			...
			$this->response->setOutput($server . 'image/tsc_image.png');
		}
	}	
}

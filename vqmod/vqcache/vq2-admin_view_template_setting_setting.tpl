      ...
      <div class="panel-body">
        ...
        <?php } ?>    
          ...
          <div class="tab-content">
			...
			<fieldset>
			<legend><?php echo $text_products_by_customer_group_prices; ?></legend>
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_enable_admin_product_customer_group_prices; ?>"><?php echo $entry_enable_admin_product_customer_group_prices; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_enable_admin_product_customer_group_prices == 1) { ?>
                    ...
                    <label class="radio-inline">
                      <?php if ($config_enable_admin_product_customer_group_prices == 0) { ?>
				...
				<div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $entry_show_admin_product_customer_group_prices_in_product_list; ?>"><?php echo $entry_show_admin_product_customer_group_prices_in_product_list; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                    ...
                    <label class="radio-inline">
                      <?php if ($config_show_admin_product_customer_group_prices_in_product_list == 0) { ?>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_update_product_customer_group_prices_in_product_list; ?>"><?php echo $entry_update_product_customer_group_prices_in_product_list; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_update_product_customer_group_prices_in_product_list == 1) { ?>
                    ...
                    <label class="radio-inline">
                      <?php if ($config_update_product_customer_group_prices_in_product_list == 0) { ?>

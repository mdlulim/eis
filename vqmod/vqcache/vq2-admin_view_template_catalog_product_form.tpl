      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <?php $existing_groups = array(); ?>
              <div class="form-group">
              <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_customer_group_prices; ?>"><?php echo $text_customer_group_prices; ?></span></label>
               <div class="col-sm-10" style="border-left:4px double #cccccc;">
                <div id="product_customer_group_price" class="">
                
                    <?php $product_customer_group_price_row = 0; ?>
                    <?php foreach ($customer_groups as $customer_group) { ?>
                    <div id="product_customer_group_price-row<?php echo $product_customer_group_price_row; ?>">
                    
                      <div class="text-left">
                      <input type="hidden" name="product_customer_group_price[<?php echo $product_customer_group_price_row; ?>][customer_group_id]" class="form-control">
                      <label><?php echo $text_customer_group_name . $customer_group['name']; ?></label>
                      </div>
                      <td class="text-right">
                      <?php if($product_customer_group_prices){ ?>
                        <?php foreach ($product_customer_group_prices as $product_customer_group_price) { ?>
                            <?php if ($customer_group['customer_group_id'] == $product_customer_group_price['customer_group_id']) { ?>
                                <input type="text" name="product_customer_group_price[<?php echo $product_customer_group_price_row; ?>][price]" value="<?php echo $product_customer_group_price['price']; ?>" placeholder="<?php echo $entry_price; ?>" class="form-control" />
                                <input type="hidden" name="product_customer_group_price[<?php echo $product_customer_group_price_row; ?>][customer_group_id]" value="<?php echo $customer_group['customer_group_id']; ?>" class="form-control" />
                        <?php array_push($existing_groups, $customer_group['customer_group_id']); ?>
                        <?php } ?>
                        <?php } ?>
                      <?php } ?>
                      <?php if(!in_array($customer_group['customer_group_id'] ,$existing_groups)){?>
                      <input type="text" name="product_customer_group_price[<?php echo $product_customer_group_price_row; ?>][price]" value="0.00" placeholder="<?php echo $entry_price; ?>" class="form-control" class="form-control" />
                      <input type="hidden" name="product_customer_group_price[<?php echo $product_customer_group_price_row; ?>][customer_group_id]" value="<?php echo $customer_group['customer_group_id']; ?>" class="form-control" />
                      <?php } ?>
                      </td> 
                    </div>
                   <br />
                    <?php $product_customer_group_price_row++; ?>
                    <?php } ?> 
                </div>
              </div>
              </div>

<?php
                ...
                $_['help_update_product_customer_groups_in_product_list']           = 'Set this to yes and all products with NO Contract Pricing assigned will be updated with all the checked default Contract Pricing from above. Use this only the first time you install this extension!';
		   		...
		   		$_['entry_show_admin_product_customer_group_prices_in_product_list']        = 'Show Contract Pricing prices in Admin product list.';
                $_['text_products_by_customer_group_prices']                                = 'Product Prices by Contract Pricing.';
                ...
                $_['help_update_product_customer_group_prices_in_product_list']             = 'Set this to yes and all Contract Pricing Prices will be updated/changed with the default price. You have to use this option only after the first installation to set the Contract Pricing Prices or whenever you want to reset all the prices. After setting this to Yes and visited the Product list, be sure to turn this option to No afterwards.';
                $_['help_enable_admin_product_customer_group_prices']                       = 'By enableing this extension the frontend of the shop will use the Contract Pricing Prices for the products';

<?php
				...
				$_['text_customer_group_prices']               = 'Contract Pricing Prices';
                $_['text_customer_group_name']                 = 'Contract Pricing: ';
                $_['help_customer_group_prices']               = 'Product prices for each Contract Pricing ';
                $_['column_customer_group_prices']             = 'Contract Pricing Prices';
                $_['text_close']                         	   = 'Close';
                $_['text_save']                         	   = 'Save';

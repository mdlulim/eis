     ...
     if (isset($this->request->get['filter_viewed'])) {
      $url .= '&filter_viewed=' . urlencode(html_entity_decode($this->request->get['filter_viewed'], ENT_QUOTES, 'UTF-8'));
		...
		$data['text_enabled'] = $this->language->get('text_enabled');
				...
				$data['text_customer_group_prices'] = $this->language->get('text_customer_group_prices');
                $data['text_customer_group_name'] = $this->language->get('text_customer_group_name');
                $data['help_customer_group_prices'] = $this->language->get('help_customer_group_prices');
                $data['column_customer_group_prices'] = $this->language->get('column_customer_group_prices');
...
$data['sort_views'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'] . '&sort=p.viewed' . $url, 'SSL');

	...
	class ControllerSimpleBlogAuthor extends Controller {
		public function index() {
			...
			if($simple_blog_author_id) {
				...
				$author_total = $this->model_simple_blog_article->getTotalArticleAuthorWise($simple_blog_author_id);
				
				$results = $this->model_simple_blog_article->getArticleAuthorWise($filter_data);
				...
				if($data['articles']) {					
					...
					$author_info = $this->model_simple_blog_article->getAuthorInformation($simple_blog_author_id);
				...
				$pagination->url = $this->url->link('simple_blog/author', 'simple_blog_author_id=' . $this->request->get['simple_blog_author_id'] . '&page={page}');

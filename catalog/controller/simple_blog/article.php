			...
			if ($simple_blog_article_id) {
				...
				if($article_info) {
					...
					foreach($related_product as $product) {
						...
						$image = ($product_info['image']) ? $this->model_tool_image->resize($product_info['image'], $this->config->get($this->config->get('config_theme') . '_image_related_width'), $this->config->get($this->config->get('config_theme') . '_image_related_height')) : false;
                ...
                $data['breadcrumbs'][] = array(
                    ...
                    'href' => $this->url->link('simple_blog/article/view&simple_blog_article_id='. $this->request->get['simple_blog_article_id'])
                );

...
class ControllerAccountForgotten extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$data['text_notice']   = sprintf($this->language->get('text_notice'), $this->config->get('config_email'), $this->config->get('config_email'));
			$data['text_footer']   = sprintf($this->language->get('text_footer'), $this->config->get('config_email'), $this->config->get('config_email'));

...
$_['text_backorder_quantity']   = 'Back Order';
$_['text_customer_group']       = 'Customer group:';
$_['text_id']                   = 'ID';
$_['text_invoice_no']           = 'Invoice No:';
$_['text_new_heading']          = 'Order Confirmation';
$_['text_new_preheader']        = 'Thank you for your order at {$store_name}.';
$_['text_new_subject_admin']    = '{$store_name} - Order {$order_id}: \'{$order_subject_products}\'';
$_['text_new_subject_customer'] = '{$store_name} - Order of \'{$order_subject_products}\'';

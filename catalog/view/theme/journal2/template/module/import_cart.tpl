<!-- Modal -->
<div class="modal fade" id="modalImportCart" tabindex="-1" role="dialog" aria-labelledby="modalImportCartLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="steps clearfix">
                    ...
                    <li role="tab" class="disabled" aria-disabled="true">
                        ...
                        <span class="step"><i class="fa fa-shopping-cart"></i></span> 
                        Add to Cart
                        </a>
                    </li>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" disabled="disabled" data-action="add_to_cart" id="button-continue">Continue</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
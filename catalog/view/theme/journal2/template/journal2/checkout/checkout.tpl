            ...
            <div class="journal-checkout">
                <div class="left">
                    ...
                    <div class="checkout-content login-box">
                        ...
                        <div class="radio">
                            <label>
                                ...
                                <?php echo $this->journal2->settings->get('one_page_lang_returning', 'Returning Customer'); ?>
                            </label>
                        </div>
                    </div>
                    <script>
                    ...
                    <div class="checkout-content checkout-login">
                        <fieldset>
                            <h2 class="secondary-title"><?php echo $this->journal2->settings->get('one_page_lang_returning', 'Returning Customer'); ?></h2>
                        ...
                        <div class="checkout-content confirm-section">
                            ...
                            <div class="radio check-privacy">
                                <label>
                                    ...
                                    <span><?php echo $text_privacy; ?></span>
                                </label>
                            </div>
                            <?php endif; ?>
...
<script>
    ...
    $('.journal-checkout .left input').on('blur', function() {
        var data = { };

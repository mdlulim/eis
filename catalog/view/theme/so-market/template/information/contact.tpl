  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
     <div class="page-title"><h1><?php echo $heading_title; ?></h1></div>
	   ...
	   <?php if ($image) { ?>
    <div id="map-canvass" class="hidden"><img src="<?php echo $image; ?>" alt="<?php echo $store; ?>" title="<?php echo $store; ?>" /></div>
    <?php } ?>
      ...
      <div class="info-contact row">
        <div class="col-sm-4 col-xs-12 info-store">
    			...
    			<?php } ?>
      			...
      			<?php } ?>
      			<?php if ($geocode) { ?>
                    <a href="https://maps.google.com/maps?q=<?php echo urlencode($geocode); ?>&hl=<?php echo $geocode_hl; ?>&t=m&z=15" target="_blank" class="btn btn-info hidden"><i class="fa fa-map-marker"></i> <?php echo $button_map; ?></a>
                    <?php } ?>
      			</address>
        </div>

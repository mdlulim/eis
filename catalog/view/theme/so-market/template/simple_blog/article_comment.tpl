    ...
    <div class="media comments">
        <div class="media-body">
            <div class="media-title">
                <span class="username"><b><?php echo $comment['author']; ?></b></span>
                <div class="time"><?php echo $comment['date_added']; ?></div>
            </div>
            <div class="media-content">
                <p><?php echo $comment['comment']; ?></p>
            </div>
            <div><a id="comment_reply" class="link" onclick="setArticleId(<?php echo $comment['simple_blog_comment_id']; ?>);"><?php echo $text_reply_comment; ?></a></div><br>
        </div>
    ...
    <?php if($comment['comment_reply']) { ?>
        <?php foreach($comment['comment_reply'] as $comment_reply) { ?>
            <div class="media comments comments-level-1">
                <div class="media-body">
                    <div class="media-title">
                        <span class="username"><b><?php echo $comment_reply['author']; ?></b></span>
                        <div class="time"><?php echo $comment_reply['date_added']; ?></div>
                    </div>
                    <div class="media-content">

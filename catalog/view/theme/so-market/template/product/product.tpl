...
<div class="container product-detail <?php echo'product-'. $getColumn;?>">
    ...
    <div id="content" class="<?php echo $class; ?>">
        <div class="row product-view product-info" >
			...
			<div class=" <?php echo ($product_columnright  && isset($html_product_right) && $html_product_right != '' && $html_product_right != '<p>&nbsp;</p>' ? 'product-view_left col-lg-10 col-xs-12' : 'col-xs-12'); ?>">
				<div class="row">
			<?php //Img Gallery Block -------?>
                <div class="content-product-left  <?php if(isset($thumbnails_position) && $thumbnails_position == 'left'){echo "col-sm-6 col-xs-12"; }else { echo "class-honizol col-sm-6 col-xs-12"; } ?>  ">
								...
								$nav.each(function () {
									$(this).owlCarousel2({
										...
										responsive:{
											...
											0:{
												items:2,
												 <?php if ($i >= 2): ?> nav: true <?php endif;?>

											},
											600:{
												items:3,
												<?php if ($i >= 3): ?> nav: true <?php endif;?>
											},
											1000:{
												items:4,
												 <?php if ($i >= 4): ?> nav:true <?php endif;?>
											}
										}
									});
								})
			...
			<div class="content-product-right  <?php if(isset($thumbnails_position) && $thumbnails_position == 'left'){echo "col-sm-6 col-xs-12"; }else { echo "col-sm-6 col-xs-12"; } ?>">
						   ...
						   <div class="cart">
							...
							<div class="add-to-links wish_comp">
								<ul class="blank">
									...
									<li class="compare">
										<a class="icon" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><i class="fa fa-bar-chart"></i></a>
									</li>
								</ul>
							</div>
			...
			<?php if ($product_columnright && isset($html_product_right) && $html_product_right != '' && $html_product_right != '<p>&nbsp;</p>') : ?>
				<div class="product-view__right col-lg-2 hidden-sm hidden-md hidden-xs slider-products">
					<?php if (isset($html_product_right) && $html_product_right != '' && $html_product_right != '<p>&nbsp;</p>') 

					echo html_entity_decode($html_product_right, ENT_QUOTES, 'UTF-8');
					 ?>

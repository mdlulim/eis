				...
				<div class="product-filter filters-panel">
				  <div class="row">
					...
					<div class="short-by-show form-inline text-right col-md-10 col-sm-8">
						...
						<div class="product-compare form-group" style="margin-left: 10px"><a href="<?php echo $compare; ?>" id="compare-total" class="btn btn-default"><?php echo $text_compare; ?></a></div>
				...
				<div class="product-filter product-filter-bottom filters-panel">
				   ...
				   <div class="short-by-show  <?php echo $short_by;?>">
					...
					<?php if (!empty($pagination)){?>
						<div class="box-pagination col-md-2 col-sm-4 text-right"><?php echo $pagination; ?></div>
					<?php }?>

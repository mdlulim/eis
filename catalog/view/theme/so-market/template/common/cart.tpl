...
<div id="cart" class="btn-group btn-shopping-cart">
  <a data-loading-text="<?php echo $text_loading; ?>" class="top_cart dropdown-toggle" data-toggle="dropdown">
    ...
    <span class="title"><?php echo $text_mycart; ?></span>
  ...
  <ul class="dropdown-menu pull-right shoppingcart-box">
      ...
      <li>
		...
		<div class="checkout clearfix">
            <a href="<?php echo $cart; ?>" class="btn btn-view-cart inverse"><i class="fa fa-shopping-cart"></i><?php echo $text_cart; ?></a>
            <a href="<?php echo $checkout; ?>" class="btn btn-checkout pull-right"><i class="fa fa-share"></i><?php echo $text_checkout; ?></a>
        </div>
      </li>
      <?php } else { ?>
      <li>
          <p class="text-center empty" style="font-weight:300;"><?php echo $text_empty; ?></p>
      </li>
      <?php } ?>
  </ul>
</div>

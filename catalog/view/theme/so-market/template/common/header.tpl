...
<?php // Begin General CSS ----- 
	...
	$this->soconfig->addCss('catalog/view/javascript/shortcode/shortcodes.css');
...
<?php // Begin Themes Scripts ----
	...
	$this->soconfig->addJs('catalog/view/javascript/shortcode/shortcodes.js');
...
<div id="wrapper" class="<?php echo $cls_wrapper; ?>">   
	...
	if(isset($typeheader)){
		...
		case "9":
			...
			break;
		case "10":
			$header10 = DIR_TEMPLATE.$theme.'/template/header/header10.tpl';
			if (file_exists($header10)) include($header10);
			else echo $header_alert; 
			break;
		case "11":
			$header11 = DIR_TEMPLATE.$theme.'/template/header/header11.tpl';
			if (file_exists($header11)) include($header11);
			else echo $header_alert; 
			break;
		case "12":
			$header12 = DIR_TEMPLATE.$theme.'/template/header/header12.tpl';
			if (file_exists($header12)) include($header12);
			else echo $header_alert; 
			break;
		}

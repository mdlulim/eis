...
?>
	...
	if(isset($typefooter)){
		...
		switch ($typefooter) {
		case "1":
			$footer1 = DIR_TEMPLATE.$theme.'/template/footer/footer.tpl';
			if (file_exists($footer1)) include($footer1);
			else echo $footer_alert;
			break;
			include(DIR_TEMPLATE.$theme.'/template/footer/footer.tpl');break;
		case "2":
		...
		include(DIR_TEMPLATE.$theme.'/template/footer/footer.tpl');
	}
	?>

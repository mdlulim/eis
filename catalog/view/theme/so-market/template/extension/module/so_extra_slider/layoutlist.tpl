...
$i = 0;
?>
<div class="moduletable module <?php echo $class_suffix; ?>">
							...
							<div class="media-left">
								<div class="item-image">
									<div class="item-img-info">
										...
										<a href="<?php echo $product['href'];?>" class="lt-image" target="<?php echo $item_link_target;?>"
										   title="<?php echo $product['nameFull']; ?>"  >
											<?php if($product_image_num ==2){?>
												<img src="<?php echo $product['thumb']?>" class="img-1" alt="<?php echo $product['nameFull'] ?>">
												<img src="<?php echo $product['thumb2']?>" class="img-2" alt="<?php echo $product['nameFull'] ?>">
											<?php }else{?>
												<img src="<?php echo $product['thumb']?>" class="img-responsive" alt="<?php echo $product['nameFull'] ?>">
											<?php }?>
										</a>

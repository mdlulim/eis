<div class="item">
	...
	<div class="thumbnail">
		<?php 
			if($blog_image):
		?>
		<a href="<?php echo $blog['link'];?>" target="<?php echo $item_link_target?>" class="item-image"> 
		...
		<?php }?>
			...
			<div class="media-subcontent">
				<?php if($display_comment){ ?>
					<span class="media-comment"><i class="fa fa-comments-o" aria-hidden="true"></i>&nbsp;<?php echo $blog['comment_count']; echo $blog['text_comment']?></span>
				<?php }?>
				<?php if($display_author){ ?>
					<span class="media-author"> <i class="fa fa-user" aria-hidden="true"></i> &nbsp;<?php echo ucwords($blog['author']); ?></span>
				<?php }?>
				
				<?php if($display_view){ ?>
					<span class="media-view"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp;<?php echo $blog['view_count']; echo $blog['text_view']?></span>
				<?php }?>
			</div>
			<?php if($display_readmore){ ?>
				<div class="readmore">

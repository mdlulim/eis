...
<div class="module <?php echo $direction_class?> <?php echo $class_suffix; ?>">
	...
	?>
		<div class="description">
			<p><?php echo html_entity_decode($pre_text);?></p>
		</div>
	<?php 
		}
	?>
		...
		<div class="ltabs-wrap ">
			...
			<div class="tab-header">
				...
				<div class="ltabs-tabs-container" data-delay="<?php echo $delay ?>"
					...
					<!--Begin Tabs-->
						<?php include("home7/default_tabs.tpl");	?>
					<!-- End Tabs-->
				</div>
			</div>
				...
				<div class="ltabs-items-container">
					...
					<div class="ltabs-items <?php echo $cls; ?>" data-total="<?php echo $items['count'] ?>">
						...
						if (!empty($child_items)) {	
							include("home7/default_items.tpl");
						} else { ?>
							<div class="ltabs-loading"></div>
						<?php  } ?>
						
						<?php 
						$classloaded = ($source_limit >= $items['count'] || $source_limit == 0) ? 'loaded' : ''; 
						...
						<div class="ltabs-loadmore"
							...
							>
							<div class="ltabs-loadmore-btn <?php echo $classloaded ?>" data-label="<?php echo ($classloaded) ? "All ready" : "Load more"; ?>">

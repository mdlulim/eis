...
<div class="modcontent">
	...
	?>
	<div class="page-top">
		<div class="page-title-categoryslider" style="display:none;">
			<span >
	...
	<div class="categoryslider-content <?php echo $class_item_full; ?> <?php echo $class_respl; ?>">
		...
		?>
		<div class="item-cat-image module banner no-margin hidden-sm hidden-xs">
		...
		<div class="slider so-category-slider not-js cols-6  products-list grid " data-effect="<?php echo $effect; ?>" >
			...
			<?php } ?>
				<div class="item-inner product-thumb transition product-item-container">
					...
					<div class="button-group">
						...
						<button class="btn-button wishlist" type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_wishlist'); ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i></button>
						<?php } ?>
						
						<?php if($display_addtocart) { ?>
						<button class="btn-button addToCart" type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_cart'); ?>" onclick="cart.add('<?php echo $product['product_id']; ?>');"><?php echo $objlang->get('button_cart'); ?></button>
						<?php } ?>		
						<?php if($display_compare) { ?>
						<button class="btn-button compare" type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_compare'); ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-bar-chart"></i></button>
						<?php } ?>
					</div> 
				</div> 

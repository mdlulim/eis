...
<div class="module <?php echo $direction_class?> <?php echo $class_suffix; ?>">
    ...
    ?>
    <div id="<?php echo $tag_id?>" class="so-deal modcontent products-list <?php echo $class_respl; ?> <?php if($button_page == "top"){echo "button-type1";}else{echo "button-type2";} ?> style2">
                ...
                <div class="product-layout">
                    ...
                    <div class="product-thumb ">
                        ...
                        ?>
                            ...
                            {?>
                                <button class="addToCart btn-button" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><?php echo $objlang->get('button_cart'); ?></button>
                            <?php
                            }?>
                            ...
                            {?>
                                <button class="compare btn-button" type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_compare'); ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-bar-chart"></i></button>
                            <?php }?>

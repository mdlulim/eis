<div class="products-list row <?php echo $listingType ?>">
		...
		<div class="product-item-container">
			<div class="left-block">
				<div class="product-image-container <?php echo $lazyload_text?> <?php if($secondimg =='2' && isset($product['thumb2'])){ echo "second_img";} ?> ">
					<img data-src="<?php echo $product['thumb']; ?>" src="<?php echo lazyload($product['thumb']); ?>"  title="<?php echo $product['name']; ?>" class="img-responsive" />
				...
				<?php if (!isset($quick_status) || $quick_status ) : ?>
					<a class="quickview iframe-link visible-lg btn-button" data-toggle="tooltip" title="<?php echo isset($quick_view_text) && is_string($quick_view_text) ? $quick_view_text : 'Quick View'; ?>" data-fancybox-type="iframe"  href="<?php echo $our_url->link('extension/soconfig/quickview','product_id='.$product['product_id']);?>"><?php echo isset($quick_view_text) && is_string($quick_view_text) ? $quick_view_text : 'Quick View'; ?> </a>
				<?php endif; ?>
				<!-- BOX BUTTON -->
			...
			<div class="right-block">
				...
				<div class="button-group">
					...
					<!-- COMPARE -->
					<button class="compare btn-button" type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-bar-chart"></i></button>
	...
	<div class="product-list product-layout">
		<div class="product-item-container">
			<div class="left-block col-md-4">
				...
				<?php if (!isset($quick_status) || $quick_status != 0) : ?>
					<a class="quickview iframe-link visible-lg" data-fancybox-type="iframe"  href="<?php echo $our_url->link('extension/soconfig/quickview','product_id='.$product['product_id']);?>"><?php echo isset($quick_view_text) && is_string($quick_view_text) ? $quick_view_text : 'Quick View'; ?> </a>
				<?php endif; ?>
			</div>
			<!-- end left block -->

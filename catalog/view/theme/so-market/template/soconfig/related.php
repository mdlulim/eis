<?php if ($products):?>
                        ...
                        <div class="product-layout">
						  <div class="product-item-container">
								<div class="left-block">
									...
									<!-- QUICK VIEW -->
									<?php if ( $quick_status ) : ?>
											<a class="quickview iframe-link visible-lg btn-button" data-fancybox-type="iframe"  href="<?php echo $our_url->link('extension/soconfig/quickview','product_id='.$product['product_id']);?>"> <?php echo isset($quick_view_text) && is_string($quick_view_text) ? $quick_view_text : 'Quick View'; ?> </a>
									<?php endif; ?>
	...
	<div class="module releate-horizontal">
            <h3 class="modtitle"><?php echo $text_related; ?></h3>

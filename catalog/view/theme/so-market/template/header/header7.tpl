...
<header id="header" class=" variant typeheader-<?php echo isset($typeheader) ? $typeheader : '1'?>">
	...
	<div class="header-top compact-hidden">
		<div class="container">
			<div class="row">
				<div class="header-top-left form-inline col-lg-4 col-md-4 col-sm-4 col-xs-7 compact-hidden">
					<?php if($lang_status):?>
						<?php echo $language; ?>
						<?php echo $currency; ?>
					<?php endif; ?>
				...
				<div class="header-top-right collapsed-block col-lg-8 col-md-8 col-sm-8 col-xs-5 compact-hidden">
	...
	<div class="header-bottom compact-hidden">
		<div class="container">
			<div class="header-bottom-inner">
				<div class="row">
					<div class="col-lg-2 col-md-3 col-sm-6 col-xs-12 menu-vertical">
						<?php echo $content_menu1; ?>
					</div>
					<div class="col-lg-10 col-md-9 col-sm-6 col-xs-12 content_menu">

<header id="header" class=" variant typeheader-<?php echo isset($typeheader) ? $typeheader : '1'?>">
	...
	<div class="header-center">
		<div class="container">
			<div class="row">
				<!-- LOGO -->
				<div class="navbar-logo col-md-3 col-sm-11 col-xs-9">
				   <?php  $this->soconfig->get_logo();?>
				</div>
				<div class="navbar-menu col-lg-7 col-md-6 col-sm-1 col-xs-3">
	...
	<div class="header-bottom compact-hidden">
		<div class="container">
			<div class="row">
				...
				<!-- BOX CONTENT SEARCH -->
				<div class="col-sm-9 col-xs-12 header-bottom-right">

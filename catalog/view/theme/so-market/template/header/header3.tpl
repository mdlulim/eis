...
<header id="header" class=" variant typeheader-<?php echo isset($typeheader) ? $typeheader : '1'?>">
				...
				<div class="header-center-right">
					...
					if($phone_status){
						if (isset($contact_number) && is_string($contact_number)) {
						 echo '<div class="form-group navbar-phone hidden-xs">'.html_entity_decode($contact_number, ENT_QUOTES, 'UTF-8').'</div>';
	...
	<div class="header-bottom compact-hidden">
		<div class="container">
			<div class="row">
				<div class="navbar-menu col-lg-8 col-md-12 col-sm-6 col-xs-2">
					<?php echo $content_menu; ?>
				
				 </div>
				<!-- BOX CONTENT SEARCH -->
				<div class="header-seach col-lg-4 col-md-12 col-sm-6 col-xs-10">

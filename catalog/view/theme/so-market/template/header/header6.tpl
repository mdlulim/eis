...
<header id="header" class=" variant typeheader-<?php echo isset($typeheader) ? $typeheader : '1'?>">
	...
	<div class="header-wrapper">
		<div class="header-top compact-hidden">
			<div class="container">
				<div class="row">
					<div class="header-top-left form-inline col-lg-3 col-md-3 col-sm-4 compact-hidden">
						<?php if($lang_status):?>
							<?php echo $language; ?>
							<?php echo $currency; ?>
						<?php endif; ?>
					...
					<div class="header-top-right collapsed-block col-lg-9 col-md-9 col-sm-8 compact-hidden">
						<div class="shopping_cart pull-right">
							<?php echo $cart; ?> 
						</div>
						<div class="active-link pull-right">
							<h5 class="tabBlockTitle visible-sm visible-xs"><a class="expander " href="#TabBlock-1"><i class="fa fa-angle-up"></i></a></h5>
		...
		<div class="header-center">
			<div class="container">
				<div class="row">
					...
					<!-- LOGO -->
					<div class="col-lg-4 col-md-4 navbar-logo">
					   <?php  $this->soconfig->get_logo();?>
					</div>
					<div class="col-lg-4 col-md-4 header-middle-right">

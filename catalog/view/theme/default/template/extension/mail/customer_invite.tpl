                ...
                <table width="560" cellpadding="0" cellspacing="0" border="0" class="container">
                  ...
                  <tr>
                    <td align="center" valign="top" style="text-align:center">
                      <img src="http://139.59.187.168/dev/image/email/Saleslogic_Wholesale.png" border="0" width="350" />
                    </td>
                  </tr>
                  <tr>
                                  ...
                                  <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tr>
                                      <td>
                                        ...
                                        <a href="<?php echo $_url;?>" target="_blank" target="_blank" title="<?php echo $_name;?>"><?php echo $_url;?></a>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td height="25" style="font-size:25px; line-height:25px;">&nbsp;</td>
                        ...
                        <tr>
                          <td align="center" valign="top">
                            ...
                            <table width="560" cellpadding="0" cellspacing="0" border="0" class="container">
                              ...
                              <tr>
                                <td valign="top" style="text-align:center">
                                  <h4 style="margin:0;padding:0"><a href="<?php echo $help_guide; ?>" target="_blank">View the Help Guide</a></h4>
                                </td>
                              </tr>
                            </table>
                ...
                <table width="560" cellpadding="0" cellspacing="0" border="0" class="container">
                  <tr>
                    <td align="center" valign="top" style="font-size:0.9em">
                      If this email was sent in error, please contact <a href="mailto:<?php echo $_email; ?>"><?php echo $_email; ?></a>
                    </td>
                  </tr>
                </table>

<div class="module <?php echo $direction_class?> <?php echo $class_suffix; ?>">
	...
	<!--[if lt IE 9]>
	<div id="<?php echo $tag_id; ?>" class="so-listing-tabs msie lt-ie9 first-load"><![endif]-->
	<!--[if IE 9]>
	<div id="<?php echo $tag_id; ?>" class="so-listing-tabs msie first-load"><![endif]-->
	<!--[if gt IE 9]><!-->
	<div id="<?php echo $tag_id; ?>" class="so-listing-tabs first-load"><!--<![endif]-->
		<?php 
		
		if (!empty($list)) {	
		?>
		<?php $http = $_SERVER["HTTPS"] == 'on' ? 'https://' : 'http://'; ?>
			...
			<div class="wap-listing-tabs products-list grid">
				...
				<div class="ltabs-items <?php echo $cls; ?>" data-total="<?php echo $items['count'] ?>">
					...
					if (!empty($child_items)) {	
						include("default/default_items.tpl");
					} else { ?>

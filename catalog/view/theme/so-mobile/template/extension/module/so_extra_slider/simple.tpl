...
<div class="modcontent">
	...
	<div class="extraslider-inner" data-effect="<?php echo $effect; ?>">
			...
			<div class="item ">
				<?php } ?>
				<div class="item-inner <?php echo $products_style; ?>">
					<!-- <div class="item-wrap-inner"> -->
							<div class="item-image">
								...
								<a href="<?php echo $product['href'];?>" target="<?php echo $item_link_target;?>" title="<?php echo $product['nameFull']; ?>" >
									...
									<?php if ($display_readmore_link == 1 && $products_style == 'style1' || $display_readmore_link == 1 &&  $products_style == 'style2') { ?>
									<a class="quick-view" href="<?php echo $product['href'];?>" title="<?php echo $product['nameFull'];?>" target="<?php echo $item_link_target;?>" >
							...
							<div class="item-info">
								...
								<?php if($display_price) { ?>
									<div  class="content_price price">
										...
										<?php } else { ?>
											<span class="price-new product-price"><?php echo $product['special']; ?></span>&nbsp;&nbsp;
											<span class="price-old"><?php echo $product['price']; ?></span>&nbsp;
										<?php } ?>
										<?php if ($product['tax']) { ?>
											<span class="hidden price-percent-reduction"><?php echo $objlang->get('text_tax'); ?> <?php echo $product['tax']; ?></span>
										<?php } ?>
									</div>
								<?php } ?>

								<?php if($display_description == 1 || $display_addtocart == 1 || $display_wishlist == 1 || $display_compare == 1 || $display_readmore_link == 1) { ?>
									<!-- Begin item-content -->
									<div class="item-content">
										...
										<?php if($display_addtocart || $display_readmore_link || $display_wishlist || $display_compare) { ?>
											<div class="button-container">
												...
												<button class="addToCart btn-button" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i>
													<?php if($nb_column0 != 6) { ?>
													<span class="hidden-xs hidden-sm hidden"><?php echo $objlang->get('button_cart'); ?></span>
													<?php } ?>
												</button>
												<?php } ?>

            ...
            <div class="content_404">
                ...
                <div class="item-right col-lg-7 col-md-7">
                    ...
                    <div class="block-bottom">
                        <a href="<?php echo $continue; ?>" class="btn btn-sn btn-revo" title="<?php echo $button_continue; ?>"><?php echo $button_continue; ?></a>
                        <a href="#" class="btn btn-sn btn-revo" title="Go Support">Go Support</a>                  
                    </div>
                </div>
            </div>

		  ...
		  <div class="left-content-product ">
			...
			<div class="content-product-right col-sm-7">
			   ...
			   <div class="form-group box-info-product">
					...
					<div class="cart">
						<input type="button"  title="<?php echo $button_cart; ?>" value="<?php echo $button_cart; ?>" data-loading-text="<?php echo $text_loading; ?>" id="button-cart" class="btn btn-mega btn-lg " />
					</div>
					<div class="add-to-links wish_comp">
						<ul class="blank">
							...
							<li class="compare">
								<a href="<?php echo $our_url->link('product/product','product_id='.$product_info['product_id']);?>"  title="<?php echo $button_detail; ?>" target="_top"  class="icon" ><i class="fa fa-chevron-right"></i> </a>
							</li>
						</ul>
					</div>
			   </div>
